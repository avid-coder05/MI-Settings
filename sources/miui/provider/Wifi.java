...
public class Wifi {
    ...
    /* loaded from: classes3.dex */
    public interface SyncState extends BaseColumns {
    ...
    /* loaded from: classes3.dex */
    public interface WifiShare extends BaseColumns {
    ...
    static {
        Uri parse = Uri.parse("content://wifi/wifi");
        CONTENT_URI = parse;
        WIFI_URI = parse.buildUpon().appendQueryParameter("caller_is_syncadapter", String.valueOf(true)).build();
    }
}
