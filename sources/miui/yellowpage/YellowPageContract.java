    ...
    public static final class HttpRequest {
        ...
        public static final class Helper {
            ...
            private String getResult(Bundle bundle) {
                return InvocationHandler.invoke(this.mContext, Method.REQUEST_HTTP, null, bundle).getString("data");
            }

            public Helper addParam(String str, String str2) {
                this.mParams.put(str, str2);
                return this;
            }

            public String requestLocal() {
                Bundle constructParams = constructParams();
                constructParams.putBoolean(HttpRequest.PARAM_INVOKE_REQUEST_LOCAL, true);
                return getResult(constructParams);
            }

            public String requestServer() {
                Bundle constructParams = constructParams();
                constructParams.putBoolean(HttpRequest.PARAM_INVOKE_REQUEST_SERVER, true);
                return getResult(constructParams);
            }

            public Helper setRequestCache(boolean z) {
                this.mRequestCache = z;
                return this;
            }

            public Helper setRequestServer(boolean z) {
                this.mRequestServer = z;
                return this;
            }

            public Helper setRequestYellowPage(boolean z) {
                this.mRequestYellowPage = z;
                return this;
            }

            public Helper setRequireLocId(boolean z) {
                this.mRequireLocId = z;
                return this;
            }

            public Helper setRequireLogin(boolean z) {
