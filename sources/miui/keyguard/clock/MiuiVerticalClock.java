...
public class MiuiVerticalClock extends MiuiBaseClock {
    ...
    public void updateTime() {
        super.updateTime();
        this.mTimeText.setText(this.mCalendar.format(this.mContext.getString(this.m24HourFormat ? R.string.miui_vertical_time_format_24 : R.string.miui_vertical_time_format_12)));
    }
    ...
    protected void updateViewsLayoutParams() {
        ...
        layoutParams2.topMargin = (int) (this.mScaleRatio * this.mResources.getDimensionPixelSize(R.dimen.miui_vertical_clock_date_info_top_margin));
