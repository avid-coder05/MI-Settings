...
public class GradientFillParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.of("nm", CloudPushConstants.WATERMARK_TYPE.GLOBAL, "o", "t", CloudPushConstants.WATERMARK_TYPE.SUBSCRIPTION, "e", "r", "hd");
