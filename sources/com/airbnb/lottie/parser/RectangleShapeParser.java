...
public class RectangleShapeParser {
    private static JsonReader.Options NAMES = JsonReader.Options.of("nm", CloudPushConstants.WATERMARK_TYPE.PERSONAL, CloudPushConstants.WATERMARK_TYPE.SUBSCRIPTION, "r", "hd");
