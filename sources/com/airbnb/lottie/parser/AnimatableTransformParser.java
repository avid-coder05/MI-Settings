...
public class AnimatableTransformParser {
    private static JsonReader.Options NAMES = JsonReader.Options.of("a", CloudPushConstants.WATERMARK_TYPE.PERSONAL, CloudPushConstants.WATERMARK_TYPE.SUBSCRIPTION, "rz", "r", "o", "so", "eo", "sk", "sa");
    private static JsonReader.Options ANIMATABLE_NAMES = JsonReader.Options.of(MiCloudSmsCmd.TYPE_LOCK);
