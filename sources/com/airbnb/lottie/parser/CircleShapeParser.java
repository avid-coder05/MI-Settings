...
public class CircleShapeParser {
    private static JsonReader.Options NAMES = JsonReader.Options.of("nm", CloudPushConstants.WATERMARK_TYPE.PERSONAL, CloudPushConstants.WATERMARK_TYPE.SUBSCRIPTION, "hd", MiCloudSmsCmd.TYPE_DISCARD_TOKEN);
