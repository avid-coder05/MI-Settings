...
public class GradientStrokeParser {
    private static JsonReader.Options NAMES = JsonReader.Options.of("nm", CloudPushConstants.WATERMARK_TYPE.GLOBAL, "o", "t", CloudPushConstants.WATERMARK_TYPE.SUBSCRIPTION, "e", MiCloudSmsCmd.TYPE_WIPE, "lc", "lj", "ml", "hd", MiCloudSmsCmd.TYPE_DISCARD_TOKEN);
    private static final JsonReader.Options GRADIENT_NAMES = JsonReader.Options.of(CloudPushConstants.WATERMARK_TYPE.PERSONAL, MiCloudSmsCmd.TYPE_LOCK);
    private static final JsonReader.Options DASH_PATTERN_NAMES = JsonReader.Options.of(MiCloudSmsCmd.TYPE_NOISE, "v");
                ...
                case 11:
                    ...
                    while (jsonReader.hasNext()) {
                        ...
                        if (str2.equals("o")) {
                            ...
                            if (str2.equals(MiCloudSmsCmd.TYPE_DISCARD_TOKEN) || str2.equals(CloudPushConstants.WATERMARK_TYPE.GLOBAL)) {
