...
public class ShapeStrokeParser {
    private static JsonReader.Options NAMES = JsonReader.Options.of("nm", "c", MiCloudSmsCmd.TYPE_WIPE, "o", "lc", "lj", "ml", "hd", MiCloudSmsCmd.TYPE_DISCARD_TOKEN);
                ...
                case 8:
                    ...
                    while (jsonReader.hasNext()) {
                        ...
                        switch (str2.hashCode()) {
                            case 100:
                                if (str2.equals(MiCloudSmsCmd.TYPE_DISCARD_TOKEN)) {
                                    c = 0;
                                    break;
                                }
                                c = 65535;
                                break;
                            case 103:
                                if (str2.equals(CloudPushConstants.WATERMARK_TYPE.GLOBAL)) {
                                    c = 1;
                                    break;
                                }
                                c = 65535;
