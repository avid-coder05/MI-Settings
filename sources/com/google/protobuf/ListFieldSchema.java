...
public abstract class ListFieldSchema {
    ...
    private static final class ListFieldSchemaFull extends ListFieldSchema {
        ...
        private static <L> List<L> mutableListAt(Object obj, long j, int i) {
            ...
            if (list.isEmpty()) {
                List<L> lazyStringArrayList2 = list instanceof LazyStringList ? new LazyStringArrayList(i) : ((list instanceof PrimitiveNonBoxingCollection) && (list instanceof Internal.ProtobufList)) ? ((Internal.ProtobufList) list).mutableCopyWithCapacity2(i) : new ArrayList<>(i);
