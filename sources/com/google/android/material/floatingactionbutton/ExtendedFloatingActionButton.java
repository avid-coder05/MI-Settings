...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public AnimatorSet createAnimator() {
            ...
            if (currentMotionSpec.hasPropertyValues(Tag.TagWebService.ContentGetImage.PARAM_IMAGE_WIDTH)) {
                PropertyValuesHolder[] propertyValues = currentMotionSpec.getPropertyValues(Tag.TagWebService.ContentGetImage.PARAM_IMAGE_WIDTH);
                propertyValues[0].setFloatValues(ExtendedFloatingActionButton.this.getWidth(), this.size.getWidth());
                currentMotionSpec.setPropertyValues(Tag.TagWebService.ContentGetImage.PARAM_IMAGE_WIDTH, propertyValues);
            }
    ...
    static {
        ...
        WIDTH = new Property<View, Float>(cls, Tag.TagWebService.ContentGetImage.PARAM_IMAGE_WIDTH) { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.4
