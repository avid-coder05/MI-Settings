...
public abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    public AnimatorSet createAnimator(MotionSpec motionSpec) {
        ...
        if (motionSpec.hasPropertyValues(Tag.TagWebService.ContentGetImage.PARAM_IMAGE_WIDTH)) {
            arrayList.add(motionSpec.getAnimator(Tag.TagWebService.ContentGetImage.PARAM_IMAGE_WIDTH, this.fab, ExtendedFloatingActionButton.WIDTH));
        }
