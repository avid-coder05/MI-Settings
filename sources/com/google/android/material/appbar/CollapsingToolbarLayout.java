    ...
    */
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if ((mode == 0 || this.forceApplySystemWindowInsetTop) && systemWindowInsetTop > 0) {
            ...
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(getMeasuredHeight() + systemWindowInsetTop, SearchUpdater.SIM));
        }
        if (this.extraMultilineHeightEnabled && this.collapsingTextHelper.getMaxLines() > 1) {
            ...
            if (lineCount > 1) {
                ...
                super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(getMeasuredHeight() + this.extraMultilineHeight, SearchUpdater.SIM));
            }
        }
        ViewGroup viewGroup = this.toolbar;
        if (viewGroup != null) {
