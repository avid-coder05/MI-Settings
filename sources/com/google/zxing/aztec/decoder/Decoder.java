...
public final class Decoder {
    ...
    private static final String[] UPPER_TABLE = {"CTRL_PS", " ", "A", "B", "C", "D", "E", TessBaseAPI.VAR_FALSE, "G", "H", "I", "J", "K", "L", "M", "N", "O", "P", "Q", "R", "S", TessBaseAPI.VAR_TRUE, "U", "V", "W", "X", "Y", "Z", "CTRL_LL", "CTRL_ML", "CTRL_DL", "CTRL_BS"};
    private static final String[] LOWER_TABLE = {"CTRL_PS", " ", "a", "b", "c", MiCloudSmsCmd.TYPE_DISCARD_TOKEN, "e", "f", CloudPushConstants.WATERMARK_TYPE.GLOBAL, "h", "i", "j", MiCloudSmsCmd.TYPE_LOCK, MiCloudSmsCmd.TYPE_LOCATION, "m", MiCloudSmsCmd.TYPE_NOISE, "o", CloudPushConstants.WATERMARK_TYPE.PERSONAL, "q", "r", CloudPushConstants.WATERMARK_TYPE.SUBSCRIPTION, "t", "u", "v", MiCloudSmsCmd.TYPE_WIPE, "x", "y", "z", "CTRL_US", "CTRL_ML", "CTRL_DL", "CTRL_BS"};
    private static final String[] MIXED_TABLE = {"CTRL_PS", " ", "\u0001", "\u0002", "\u0003", "\u0004", "\u0005", "\u0006", "\u0007", "\b", "\t", "\n", "\u000b", "\f", "\r", "\u001b", "\u001c", "\u001d", "\u001e", "\u001f", "@", "\\", "^", "_", "`", "|", "~", "\u007f", "CTRL_LL", "CTRL_UL", "CTRL_PL", "CTRL_BS"};
    private static final String[] PUNCT_TABLE = {"", "\r", "\r\n", ". ", ", ", ": ", "!", "\"", "#", "$", "%", "&", "'", "(", ")", "*", CountryCode.GSM_GENERAL_IDD_CODE, ",", "-", ".", "/", ":", ExtraContacts.ConferenceCalls.SPLIT_EXPRESSION, "<", "=", ">", "?", "[", "]", "{", "}", "CTRL_UL"};
    private static final String[] DIGIT_TABLE = {"CTRL_PS", " ", "0", "1", "2", ExtraTelephony.Phonelist.TYPE_VIP, ExtraTelephony.Phonelist.TYPE_CLOUDS_BLACK, ExtraTelephony.Phonelist.TYPE_CLOUDS_WHITE, ExtraTelephony.Phonelist.TYPE_STRONG_CLOUDS_BLACK, ExtraTelephony.Phonelist.TYPE_STRONG_CLOUDS_WHITE, "8", "9", ",", ".", "CTRL_UL", "CTRL_US"};
    ...
    boolean[] extractBits(BitMatrix bitMatrix) {
        ...
        int i8 = 0;
        while (i7 < nbLayers) {
            int i9 = (nbLayers - i7) * 4;
            int i10 = isCompact ? i9 + 9 : i9 + 12;
            int i11 = i7 * 2;
            int i12 = (i - 1) - i11;
            int i13 = 0;
            while (i13 < i10) {
