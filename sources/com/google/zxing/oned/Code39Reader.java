        ...
        while (true) {
            ...
            if (patternToChar == '*') {
                ...
                if (nextSet2 == size || (i6 >> 1) >= i4) {
                    ...
                    if (sb.length() != 0) {
                        float f = i;
                        return new Result(this.extendedMode ? decodeExtended(sb) : sb.toString(), null, new ResultPoint[]{new ResultPoint((r2[1] + r2[0]) / 2.0f, f), new ResultPoint((nextSet2 + nextSet) / 2.0f, f)}, BarcodeFormat.CODE_39);
                    }
                    throw NotFoundException.getNotFoundInstance();
                }
                throw NotFoundException.getNotFoundInstance();
