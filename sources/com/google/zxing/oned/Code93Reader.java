        ...
        while (true) {
            ...
            if (patternToChar == '*') {
                ...
                if (sb.length() >= 2) {
                    ...
                    float f = i;
                    return new Result(decodeExtended(sb), null, new ResultPoint[]{new ResultPoint((r13[1] + r13[0]) / 2.0f, f), new ResultPoint((nextSet2 + nextSet) / 2.0f, f)}, BarcodeFormat.CODE_93);
                }
                throw NotFoundException.getNotFoundInstance();
            }
            nextSet = nextSet2;
