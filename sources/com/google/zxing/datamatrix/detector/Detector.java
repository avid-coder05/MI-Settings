...
public final class Detector {
    ...
    public DetectorResult detect() throws NotFoundException {
        ...
        ResultPoint resultPoint6 = resultPointArr[0];
        ResultPoint resultPoint7 = resultPointArr[1];
        ResultPoint resultPoint8 = resultPointArr[2];
        ResultPoint resultPoint9 = !hashMap.containsKey(resultPoint2) ? resultPoint2 : !hashMap.containsKey(resultPoint3) ? resultPoint3 : !hashMap.containsKey(resultPoint4) ? resultPoint4 : resultPoint5;
        int transitions = transitionsBetween(resultPoint8, resultPoint9).getTransitions();
        int transitions2 = transitionsBetween(resultPoint6, resultPoint9).getTransitions();
        if ((transitions & 1) == 1) {
            transitions++;
        }
        int i = transitions + 2;
        ...
        if (i * 4 >= i2 * 7 || i2 * 4 >= i * 7) {
            ...
            ResultPoint correctTopRightRectangular = correctTopRightRectangular(resultPoint7, resultPoint6, resultPoint8, resultPoint9, i, i2);
            if (correctTopRightRectangular != null) {
                resultPoint9 = correctTopRightRectangular;
            }
            int transitions3 = transitionsBetween(resultPoint, resultPoint9).getTransitions();
            int transitions4 = transitionsBetween(resultPoint6, resultPoint9).getTransitions();
            if ((transitions3 & 1) == 1) {
                transitions3++;
            }
            int i3 = transitions3;
            ...
            sampleGrid = sampleGrid(this.image, resultPoint, resultPoint7, resultPoint6, resultPoint9, i3, transitions4);
        } else {
            ResultPoint correctTopRight = correctTopRight(resultPoint7, resultPoint6, resultPoint8, resultPoint9, Math.min(i2, i));
            if (correctTopRight != null) {
                resultPoint9 = correctTopRight;
            }
            int max = Math.max(transitionsBetween(resultPoint8, resultPoint9).getTransitions(), transitionsBetween(resultPoint6, resultPoint9).getTransitions()) + 1;
            if ((max & 1) == 1) {
                max++;
            }
            int i4 = max;
            sampleGrid = sampleGrid(this.image, resultPoint8, resultPoint7, resultPoint6, resultPoint9, i4, i4);
            resultPoint = resultPoint8;
        }
        return new DetectorResult(sampleGrid, new ResultPoint[]{resultPoint, resultPoint7, resultPoint6, resultPoint9});
    }
}
