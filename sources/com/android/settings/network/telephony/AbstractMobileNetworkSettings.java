...
public abstract class AbstractMobileNetworkSettings extends RestrictedDashboardFragment {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: updateVisiblePreferenceControllers  reason: merged with bridge method [inline-methods] */
    ...
    public void onExpandButtonClick() {
        ...
        this.mHiddenControllerList.stream().filter(new Predicate() { // from class: com.android.settings.network.telephony.AbstractMobileNetworkSettings$$ExternalSyntheticLambda4
        ...
        }).forEach(new Consumer() { // from class: com.android.settings.network.telephony.AbstractMobileNetworkSettings$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public void redrawPreferenceControllers() {
        ...
        Log.d("AbsNetworkSettings", "redraw fragment: +" + (SystemClock.elapsedRealtime() - elapsedRealtime) + "ms");
