...
public class NetworkScanHelper {
    ...
    NetworkScanRequest createNetworkScanForPreferredAccessNetworks() {
        ...
        if (preferredNetworkTypeBitmask == 0 || (32843 & preferredNetworkTypeBitmask) != 0) {
            arrayList.add(new RadioAccessSpecifier(1, null, null));
        }
        if (preferredNetworkTypeBitmask == 0 || (93108 & preferredNetworkTypeBitmask) != 0) {
            arrayList.add(new RadioAccessSpecifier(2, null, null));
        }
        if (preferredNetworkTypeBitmask == 0 || (397312 & preferredNetworkTypeBitmask) != 0) {
            arrayList.add(new RadioAccessSpecifier(3, null, null));
        }
        if (preferredNetworkTypeBitmask == 0 || (hasNrSaCapability() && (preferredNetworkTypeBitmask & PlaybackStateCompat.ACTION_SET_SHUFFLE_MODE_ENABLED) != 0)) {
