...
public class SubscriptionGrouping implements UnaryOperator<List<SubscriptionAnnotation>> {
    ...
    public List<SubscriptionAnnotation> apply(List<SubscriptionAnnotation> list) {
        ...
        Map map = (Map) list.stream().filter(new Predicate() { // from class: com.android.settings.network.helper.SubscriptionGrouping$$ExternalSyntheticLambda3
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return Objects.nonNull((SubscriptionAnnotation) obj);
            }
        }).collect(Collectors.groupingBy(new Function() { // from class: com.android.settings.network.helper.SubscriptionGrouping$$ExternalSyntheticLambda2
            @Override // java.util.function.Function
    ...
    @Keep
    /* renamed from: getGroupUuid  reason: merged with bridge method [inline-methods] */
    ...
    protected SubscriptionAnnotation selectBestFromList(final List<SubscriptionAnnotation> list) {
        return list.stream().sorted(new Comparator() { // from class: com.android.settings.network.helper.SubscriptionGrouping$$ExternalSyntheticLambda0
