...
public class SelectableSubscriptions implements Callable<List<SubscriptionAnnotation>> {
    ...
    public SelectableSubscriptions(final Context context, boolean z) {
        ...
        this.mSubscriptions = z ? new Supplier() { // from class: com.android.settings.network.helper.SelectableSubscriptions$$ExternalSyntheticLambda8
        ...
        } : new Supplier() { // from class: com.android.settings.network.helper.SelectableSubscriptions$$ExternalSyntheticLambda9
            @Override // java.util.function.Supplier
            public final Object get() {
                List lambda$new$1;
        ...
        if (z) {
            this.mFilter = new Predicate() { // from class: com.android.settings.network.helper.SelectableSubscriptions$$ExternalSyntheticLambda7
            ...
            this.mFilter = new Predicate() { // from class: com.android.settings.network.helper.SelectableSubscriptions$$ExternalSyntheticLambda6
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                    boolean isActive;
        ...
        this.mFinisher = new Function() { // from class: com.android.settings.network.helper.SelectableSubscriptions$$ExternalSyntheticLambda3
    ...
    protected static List<Integer> atomicToList(final AtomicIntegerArray atomicIntegerArray) {
        return atomicIntegerArray == null ? Collections.emptyList() : (List) IntStream.range(0, atomicIntegerArray.length()).map(new IntUnaryOperator() { // from class: com.android.settings.network.helper.SelectableSubscriptions$$ExternalSyntheticLambda5
    ...
    /* renamed from: getActiveSubInfoList  reason: merged with bridge method [inline-methods] */
    public List<SubscriptionInfo> lambda$new$1(Context context) {
        return getSubInfoList(context, new Function() { // from class: com.android.settings.network.helper.SelectableSubscriptions$$ExternalSyntheticLambda1
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    /* renamed from: getAvailableSubInfoList  reason: merged with bridge method [inline-methods] */
    public List<SubscriptionInfo> lambda$new$0(Context context) {
        return getSubInfoList(context, new Function() { // from class: com.android.settings.network.helper.SelectableSubscriptions$$ExternalSyntheticLambda2
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
