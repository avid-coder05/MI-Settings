...
public class PrivateDnsPreferenceController extends BasePreferenceController implements PreferenceControllerMixin, LifecycleObserver, OnStart, OnStop {
    ...
    public CharSequence getSummary() {
        ...
        return privateDnsMode != 1 ? privateDnsMode != 2 ? privateDnsMode != 3 ? "" : z ? PrivateDnsModeDialogPreference.getHostnameFromSettings(contentResolver) : resources.getString(R.string.private_dns_mode_provider_failure) : z ? resources.getString(R.string.private_dns_mode_on) : resources.getString(R.string.private_dns_mode_opportunistic) : resources.getString(R.string.private_dns_mode_off);
    }
    ...
    public void updateState(Preference preference) {
        ...
        ((RestrictedPreference) preference).setSummary2Value(true);
    }
