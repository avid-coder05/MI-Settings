...
public class AdaptiveConnectivityPreferenceController extends BasePreferenceController {
    ...
    public CharSequence getSummary() {
        return Settings.Secure.getInt(this.mContext.getContentResolver(), "adaptive_connectivity_enabled", 1) == 1 ? this.mContext.getString(R.string.adaptive_connectivity_switch_on) : this.mContext.getString(R.string.adaptive_connectivity_switch_off);
    }
