...
public class RingtoneItemNotification extends LinearLayout {
    public ImageView imageView;
    public TextView summary;
    public TextView title;
    private int type;

    public RingtoneItemNotification(Context context) {
        super(context);
        init(context);
    }

    public RingtoneItemNotification(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        init(context);
    }

    private int getResourceId() {
        int i = R.layout.ringtone_item_notification;
