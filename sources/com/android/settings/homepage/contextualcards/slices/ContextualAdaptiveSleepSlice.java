...
public class ContextualAdaptiveSleepSlice implements CustomSliceable {
    ...
    private boolean isRecentlySetup() {
        return this.mContext.getSharedPreferences("adaptive_sleep_slice", 0).getLong(PREF_KEY_SETUP_TIME, 0L) > System.currentTimeMillis() - DEFERRED_TIME_DAYS;
    }
    ...
    public Slice getSlice() {
        if (this.mContext.getSharedPreferences("adaptive_sleep_slice", 0).getLong(PREF_KEY_SETUP_TIME, 0L) == 0) {
