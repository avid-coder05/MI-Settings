...
public class EligibleCardChecker implements Callable<ContextualCard> {
    ...
    Slice bindSlice(final Uri uri) {
        ...
        final EligibleCardChecker$$ExternalSyntheticLambda0 eligibleCardChecker$$ExternalSyntheticLambda0 = new SliceViewManager.SliceCallback() { // from class: com.android.settings.homepage.contextualcards.EligibleCardChecker$$ExternalSyntheticLambda0
