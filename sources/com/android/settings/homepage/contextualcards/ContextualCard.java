...
public class ContextualCard {
    ...
    public ContextualCard(Cursor cursor) {
        ...
        int i2 = cursor.getInt(cursor.getColumnIndex(YellowPageStatistic.Display.CATEGORY));
        this.mCategory = i2;
        builder.setCategory(i2);
        String string3 = cursor.getString(cursor.getColumnIndex(ExtraNetwork.FIREWALL_PACKAGE_NAME));
