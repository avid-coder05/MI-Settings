...
public class WifiCallingSliceHelper {
    ...
    private Slice getNonActionableWifiCallingSlice(CharSequence charSequence, CharSequence charSequence2, Uri uri, PendingIntent pendingIntent) {
        ...
        return new ListBuilder(this.mContext, uri, -1L).setAccentColor(com.android.settingslib.Utils.getColorAccentDefaultColor(this.mContext)).addRow(primaryAction).build();
    }
    ...
    private Slice getWifiCallingPreferenceSlice(boolean z, int i, Uri uri, int i2) {
        ...
        ListBuilder accentColor = new ListBuilder(this.mContext, uri, -1L).setAccentColor(com.android.settingslib.Utils.getColorAccentDefaultColor(this.mContext));
        ...
        if (z) {
            accentColor.addRow(wifiPreferenceRowBuilder(accentColor, 17041728, "com.android.settings.slice.action.WIFI_CALLING_PREFERENCE_WIFI_ONLY", i == 0, i2));
        }
        accentColor.addRow(wifiPreferenceRowBuilder(accentColor, 17041729, "com.android.settings.slice.action.WIFI_CALLING_PREFERENCE_WIFI_PREFERRED", i == 2, i2));
        accentColor.addRow(wifiPreferenceRowBuilder(accentColor, 17041727, "com.android.settings.slice.action.WIFI_CALLING_PREFERENCE_CELLULAR_PREFERRED", i == 1, i2));
    ...
    private CharSequence getWifiCallingPreferenceSummary(int i, int i2) {
        ...
        if (i != 0) {
            if (i != 1) {
                ...
                return resourcesForSubId.getText(17041729);
            }
            return resourcesForSubId.getText(17041727);
        }
        return resourcesForSubId.getText(17041728);
    }
