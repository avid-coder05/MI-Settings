...
public class TetherService extends Service {
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() { // from class: com.android.settings.wifi.tether.TetherService.1
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (!intent.getAction().equals(TetherService.this.mExpectedProvisionResponseAction)) {
                ...
                TelephonyManager telephonyManager = (TelephonyManager) TetherService.this.getSystemService("phone");
                if (telephonyManager != null && !"44020".equals(telephonyManager.getSimOperatorNumeric(TetherService.this.getTetherServiceWrapper().getActiveDataSubscriptionId()))) {
                    Log.e("TetherService", "Not operator sim! Default result is RESULT_OK!");
                    intExtra = -1;
                }
                if (intExtra != -1) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public TetherServiceWrapper getTetherServiceWrapper() {
