...
public class NetworkRequestSingleSsidDialogFragment extends NetworkRequestDialogBaseFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        if (getArguments() != null) {
            ...
            str = getArguments().getString("DIALOG_REQUEST_SSID", "");
        } else {
            z = false;
        }
        ...
        AlertDialog.Builder neutralButton = new AlertDialog.Builder(context, R.style.AlertDialog_Theme_DayNight).setCustomTitle(inflate).setMessage(str).setPositiveButton(z ? R.string.network_connection_timeout_dialog_ok : R.string.wifi_connect, new DialogInterface.OnClickListener() { // from class: com.android.settings.wifi.NetworkRequestSingleSsidDialogFragment$$ExternalSyntheticLambda0
