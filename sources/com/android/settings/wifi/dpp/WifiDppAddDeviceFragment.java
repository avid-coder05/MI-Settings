...
public class WifiDppAddDeviceFragment extends WifiDppQrCodeBaseFragment {
    ...
    private void startWifiDppConfiguratorInitiator() {
        new WifiDppInitiatorViewModel(getActivity().getApplication()).startEasyConnectAsConfiguratorInitiator(((WifiDppConfiguratorActivity) getActivity()).getWifiDppQrCode().getQrCode(), ((WifiDppConfiguratorActivity) getActivity()).getWifiNetworkConfig().getNetworkId());
    }
