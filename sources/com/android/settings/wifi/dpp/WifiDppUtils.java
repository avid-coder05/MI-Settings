...
public class WifiDppUtils {
    ...
    private static boolean QR_MUTUAL_QRCODE_GENERATOR = false;
    private static boolean NETROLE_AP_QRCODE_GENERATOR = false;
    ...
    public static Intent getEnrolleeQrCodeScannerIntent(Context context, String str, boolean z) {
        Intent intent = new Intent("miui.settings.WIFI_DPP_ENROLLEE_QR_CODE_SCANNER");
    ...
    public static Intent getMiuiConfiguratorQrCodeScannerIntentOrNull(Context context, WifiManager wifiManager, AccessPoint accessPoint) {
        Intent intent = new Intent(context, MiuiWifiDppConfiguratorActivity.class);
        if (SettingsFeatures.isSplitTablet(context)) {
            intent.addMiuiFlags(8);
        }
    ...
    public static Intent getMiuiConfiguratorQrCodeScannerIntentOrNull(Context context, WifiManager wifiManager, WifiEntry wifiEntry) {
        Intent intent = new Intent(context, MiuiWifiDppConfiguratorActivity.class);
