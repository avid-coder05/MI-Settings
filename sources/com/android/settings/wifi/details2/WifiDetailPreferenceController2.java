...
public class WifiDetailPreferenceController2 extends AbstractPreferenceController implements PreferenceControllerMixin, WifiDialog2.WifiDialog2Listener, LifecycleObserver, OnPause, OnResume, WifiEntry.WifiEntryCallback, WifiEntry.ConnectCallback, WifiEntry.DisconnectCallback, WifiEntry.ForgetCallback, WifiEntry.SignInCallback {
    ...
    public static class IconInjector {
        ...
        public Drawable getIcon(boolean z, int i) {
            return this.mContext.getDrawable(WifiUtils.getInternetIconResource(i, z)).mutate();
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: launchWifiDppConfiguratorActivity  reason: merged with bridge method [inline-methods] */
    ...
    private Drawable redrawIconForHeader(Drawable drawable) {
        ...
        if (!(minimumWidth == dimensionPixelSize && minimumHeight == dimensionPixelSize) && VectorDrawable.class.isInstance(drawable)) {
            ...
            BitmapDrawable bitmapDrawable = new BitmapDrawable((Resources) null, Utils.createBitmap(drawable, dimensionPixelSize, dimensionPixelSize));
            bitmapDrawable.setTintList(com.android.settingslib.Utils.getColorAttr(this.mContext, 16842806));
    ...
    public void refreshButtons() {
        ...
        boolean z = this.mWifiEntry.canConnect() || this.mWifiEntry.canDisconnect();
        ...
        this.mButtonsPref.setButton3Visible(z || this.mWifiEntry.getConnectedState() == 1);
        ...
        this.mButtonsPref.setVisible(canForgetNetwork || updateCaptivePortalButton || z || canShareNetwork);
    }
    ...
    private void refreshFrequency() {
        ...
        if (i >= 2400 && i < 2500) {
            ...
            if (this.mWifiEntry.getConnectedState() == 1) {
                this.mFrequencyPref.setVisible(false);
                return;
            }
    ...
    public void refreshIpLayerInfo() {
        ...
        String str4 = (String) this.mLinkProperties.getDnsServers().stream().map(WifiDetailPreferenceController2$$ExternalSyntheticLambda8.INSTANCE).collect(Collectors.joining("\n"));
    ...
    private void refreshRssiViews() {
        ...
        mutate.setTintList(com.android.settingslib.Utils.getColorAttr(this.mContext, 16843817));
    ...
    private void signIntoNetwork() {
        this.mMetricsFeatureProvider.action(this.mFragment.getActivity(), PageIndexManager.PAGE_FACTORY_RESET, new Pair[0]);
    ...
    public boolean canForgetNetwork() {
        return this.mWifiEntry.canForget() && !com.android.settings.wifi.WifiUtils.isNetworkLockedDown(this.mContext, this.mWifiEntry.getWifiConfiguration());
    }

    public boolean canModifyNetwork() {
        return this.mWifiEntry.isSaved() && !com.android.settings.wifi.WifiUtils.isNetworkLockedDown(this.mContext, this.mWifiEntry.getWifiConfiguration());
    }
