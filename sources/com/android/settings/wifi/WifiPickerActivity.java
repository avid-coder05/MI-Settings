...
public class WifiPickerActivity extends SettingsActivity {
    ...
    Class<? extends PreferenceFragment> getWifiSettingsClass() {
        return MiuiWifiSettings.class;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // com.android.settings.SettingsActivity
    public boolean isValidFragment(String str) {
        return MiuiWifiSettings.class.getName().equals(str) || WifiP2pSettings.class.getName().equals(str) || SavedAccessPointsWifiSettings2.class.getName().equals(str);
    }
}
