...
public final class MiuiQrYUVLuminanceSource extends LuminanceSource {
    ...
    public MiuiQrYUVLuminanceSource(byte[] bArr, int i, int i2, int i3, int i4, int i5, int i6, boolean z) {
        super(i5, i6);
        if (i3 + i5 > i || i4 + i6 > i2) {
