...
public class ModuleLicensesPreferenceController extends BasePreferenceController {
    ...
    /* loaded from: classes.dex */
    public static class Predicate implements java.util.function.Predicate<ModuleInfo> {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        installedModules.stream().sorted(Comparator.comparing(new Function() { // from class: com.android.settings.deviceinfo.legal.ModuleLicensesPreferenceController$$ExternalSyntheticLambda1
        ...
        })).filter(new Predicate(this.mContext)).forEach(new Consumer() { // from class: com.android.settings.deviceinfo.legal.ModuleLicensesPreferenceController$$ExternalSyntheticLambda0
