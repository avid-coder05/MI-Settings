...
public abstract class StorageWizardBase extends ObservableActivity {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public void setThirdlyBodyText(int i, String... strArr) {
        TextView textView = (TextView) findViewById(R.id.storage_wizard_third_body);
        textView.setText(TextUtils.expandTemplate(getText(i), strArr));
        textView.setVisibility(0);
    }
