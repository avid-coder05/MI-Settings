...
public class StorageUtils {
    ...
    public static class UnmountTask extends AsyncTask<Void, Void, Exception> {
        ...
        public void onPostExecute(Exception exc) {
            ...
            Context context = this.mContext;
            Toast.makeText(context, context.getString(R.string.storage_unmount_failure, this.mDescription), 0).show();
        }
    }

    public static List<StorageEntry> getAllStorageEntries(final Context context, final StorageManager storageManager) {
        ArrayList arrayList = new ArrayList();
        arrayList.addAll((Collection) storageManager.getVolumes().stream().filter(new Predicate() { // from class: com.android.settings.deviceinfo.storage.StorageUtils$$ExternalSyntheticLambda5
        ...
        }).map(new Function() { // from class: com.android.settings.deviceinfo.storage.StorageUtils$$ExternalSyntheticLambda0
        ...
        arrayList.addAll((Collection) storageManager.getDisks().stream().filter(new Predicate() { // from class: com.android.settings.deviceinfo.storage.StorageUtils$$ExternalSyntheticLambda4
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
        ...
        }).map(new Function() { // from class: com.android.settings.deviceinfo.storage.StorageUtils$$ExternalSyntheticLambda2
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
