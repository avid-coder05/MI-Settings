...
public class UpdatableListPreferenceDialogFragment extends PreferenceDialogFragmentCompat implements Instrumentable {
    ...
    public void onDialogClosed(boolean z) {
        ...
        getListPreference();
        this.mEntryValues[this.mClickedDialogEntryIndex].toString();
    }
    ...
    public void onPrepareDialogBuilder(AlertDialog.Builder builder) {
        ...
        builder.setSingleChoiceItems(arrayAdapter, this.mClickedDialogEntryIndex, new DialogInterface.OnClickListener() { // from class: com.android.settings.widget.UpdatableListPreferenceDialogFragment$$ExternalSyntheticLambda0
