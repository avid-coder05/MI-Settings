...
public class InstallCompatibility {
    ...
    public String toString() {
        return "InstallCompatibility : PackageName = " + this.mPackageName + " Message = " + this.mMessage + " Precise = " + this.mPrecise + " Versions = " + this.mVersions.toString();
    }
}
