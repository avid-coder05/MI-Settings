    ...
    private final BroadcastReceiver mCancelReceiver = new BroadcastReceiver() { // from class: com.android.settings.bluetooth.BluetoothPairingService.1
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals("android.bluetooth.device.action.BOND_STATE_CHANGED")) {
                ...
                Log.d("BluetoothPairingService", "Dismiss pairing for  (" + BluetoothPairingService.this.mDevice.getName() + "), BondState: " + intent.getIntExtra("android.bluetooth.device.extra.BOND_STATE", Integer.MIN_VALUE));
            }
