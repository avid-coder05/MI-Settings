...
public class MiuiHeadsetAncAdjustView extends View {
    ...
    private AncLevelChangeListener mListener;
    ...
    /* loaded from: classes.dex */
    public interface AncLevelChangeListener {
    ...
    private class LabeledSeekBarExploreByTouchHelper extends ExploreByTouchHelper {
        ...
        final /* synthetic */ MiuiHeadsetAncAdjustView this$0;
            ...
            if (i != -1 && i2 == 16) {
                if (i != this.this$0.mCurrentPointIndex) {
                    ...
                    if (this.this$0.mListener != null) {
                        this.this$0.mListener.onAncLevelChange(this.this$0.isRtl() ? (this.this$0.mPointCount - 1) - this.this$0.mCurrentPointIndex : this.this$0.mCurrentPointIndex);
                    }
    ...
    public MiuiHeadsetAncAdjustView(Context context) {
        super(context);
        this.mPointCount = 3;
        this.mCurrentPointIndex = 2;
        this.mLastCurrentPointIndex = 2;
    ...
    public MiuiHeadsetAncAdjustView(Context context, AttributeSet attributeSet, int i) {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (DBG.booleanValue()) {
            Log.d("MiuiHeadsetAncAdjustView", "onDraw");
        }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (isEnabled() && motionEvent.getAction() == 1) {
            ...
            if (bool.booleanValue()) {
                Log.d("MiuiHeadsetAncAdjustView", "mCurrentPointIndex: " + this.mCurrentPointIndex + " nearestIndex: " + i);
            }
            if (i != this.mCurrentPointIndex) {
                this.mCurrentPointIndex = i;
                if (this.mListener != null) {
                    if (bool.booleanValue()) {
                        Log.d("MiuiHeadsetAncAdjustView", "Anc level change!");
                    }
                    this.mListener.onAncLevelChange(isRtl() ? (this.mPointCount - 1) - this.mCurrentPointIndex : this.mCurrentPointIndex);
                }
                invalidate();
    ...
    public void setAncLevelChangeListener(AncLevelChangeListener ancLevelChangeListener) {
        this.mListener = ancLevelChangeListener;
    }
