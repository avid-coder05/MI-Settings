...
public class TextToSpeechSettings extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener, GearPreference.OnGearClickListener {
    ...
    private Button mTtsPlay;
    private Button mTtsReset;
    ...
    /* loaded from: classes2.dex */
    public static class TtsSettingsUtteranceProgressListener extends UtteranceProgressListener {
        private TtsSettingsUtteranceProgressListener() {
        }
    ...
    private void getSampleText() {
        ...
        intent.putExtra(Tag.TagSearch.GeoInfo.COUNTRY, this.mCurrentDefaultLocale.getCountry());
    ...
    private void initSettings() {
        ...
        if (!(getActivity() instanceof SettingsActivity) && !(getActivity() instanceof MiuiSettings)) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$successSetup$0() {
        this.mLocalePreference.setEnabled(true);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ int lambda$updateDefaultLocalePref$1(Collator collator, Pair pair, Pair pair2) {
        return collator.compare((String) pair.first, (String) pair2.first);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateWidgetState$2(boolean z) {
        Button button = this.mTtsPlay;
        if (button != null) {
            button.setEnabled(z);
        }
    ...
    private void setTtsUtteranceProgressListener() {
        ...
        textToSpeech.setOnUtteranceProgressListener(new TtsSettingsUtteranceProgressListener());
    }
    ...
    private void successSetup() {
        ...
        checkDefaultLocale();
        getActivity().runOnUiThread(new Runnable() { // from class: com.android.settings.tts.TextToSpeechSettings$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                TextToSpeechSettings.this.lambda$successSetup$0();
            }
        });
    }

    private void updateDefaultLocalePref(Intent intent) {
        if (this.mTts.getCurrentEngine() == null) {
            Log.e("TextToSpeechSettings", "Voice data check complete, but no engine bound");
        } else if (intent == null) {
            Log.e("TextToSpeechSettings", "Engine failed voice data integrity check (null return)" + this.mTts.getCurrentEngine());
        } else {
            ...
            Locale localePrefForEngine = this.mEnginesHelper.isLocaleSetToDefaultForEngine(this.mTts.getCurrentEngine()) ? null : this.mEnginesHelper.getLocalePrefForEngine(this.mTts.getCurrentEngine());
            ...
            Collections.sort(arrayList, new Comparator() { // from class: com.android.settings.tts.TextToSpeechSettings$$ExternalSyntheticLambda3
                @Override // java.util.Comparator
                public final int compare(Object obj, Object obj2) {
                    int lambda$updateDefaultLocalePref$1;
                    lambda$updateDefaultLocalePref$1 = TextToSpeechSettings.lambda$updateDefaultLocalePref$1(collator, (Pair) obj, (Pair) obj2);
                    return lambda$updateDefaultLocalePref$1;
                }
            });
    ...
    private void updateWidgetState(final boolean z) {
        if (getActivity() == null) {
            return;
        }
        getActivity().runOnUiThread(new Runnable() { // from class: com.android.settings.tts.TextToSpeechSettings$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                TextToSpeechSettings.this.lambda$updateWidgetState$2(z);
            }
        });
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        ((MiuiSeekBarPreference) this.mDefaultPitchPref).setShowTitleIcon(false);
        ((MiuiSeekBarPreference) this.mDefaultRatePref).setShowTitleIcon(false);
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(R.layout.tts_settings, viewGroup, false);
        ((ViewGroup) inflate.findViewById(R.id.prefs_container)).addView(super.onCreateView(layoutInflater, viewGroup, bundle));
        Button button = (Button) inflate.findViewById(R.id.tts_play);
        this.mTtsPlay = button;
        Folme.useAt(button).touch().handleTouchOf(this.mTtsPlay, new AnimConfig[0]);
        this.mTtsPlay.setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.tts.TextToSpeechSettings.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                TextToSpeechSettings.this.speakSampleText();
            }
        });
        Button button2 = (Button) inflate.findViewById(R.id.tts_reset);
        this.mTtsReset = button2;
        Folme.useAt(button2).touch().handleTouchOf(this.mTtsReset, new AnimConfig[0]);
        this.mTtsReset.setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.tts.TextToSpeechSettings.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
