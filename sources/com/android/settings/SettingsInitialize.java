...
public class SettingsInitialize extends BroadcastReceiver {
    private void managedProfileSetup(Context context, PackageManager packageManager, Intent intent, UserInfo userInfo) {
        ...
        packageManager.setComponentEnabledSetting(new ComponentName("com.android.settings", "com.android.settings.MainSettings"), 2, 1);
    ...
    /* renamed from: refreshExistingShortcuts  reason: merged with bridge method [inline-methods] */
