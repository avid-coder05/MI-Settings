...
public class EnterpriseModeController extends BasePreferenceController {
    private Activity mActivity;

    public EnterpriseModeController(Context context, Activity activity, String str) {
        super(context, str);
    ...
    public int getAvailabilityStatus() {
        return OtherPersonalSettingsTree.isExcludeEnterpriseMode() ? 3 : 0;
    }
