...
import com.android.settings.MiuiSecurityStatusSettings;
...
public class DashboardFragmentRegistry {
    ...
    static {
        ...
        arrayMap.put(MiuiSecurityStatusSettings.class.getName(), "com.android.settings.category.ia.security");
        arrayMap.put(MiuiWirelessSettings.class.getName(), "com.android.settings.category.ia.device");
