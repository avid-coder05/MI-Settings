...
public class ChooseSmsLockPattern extends ChooseLockPattern {

    /* loaded from: classes.dex */
    public static class ChooseSmsFragment extends ChooseLockPattern.ChooseLockPatternFragment {
        ...
        public void onCreate(Bundle bundle) {
            ...
            if ("com.android.mms".equals(callingPackage) || "com.android.settings".equals(callingPackage)) {
                return;
            }
        ...
        public void preSetupViews() {
            ChooseLockPattern.ChooseLockPatternFragment.Stage.Introduction.headerMessage = R.string.private_sms_recording_intro_header;
        }
        ...
        public void saveChosenPatternAndFinish() {
            ...
            this.mChooseLockSettingsHelper.setPrivateSmsEnabledAsUser(true, myUserId);
    ...
    public Intent getIntent() {
        ...
        intent.putExtra(":settings:show_fragment", ChooseSmsFragment.class.getName());
        return intent;
    }
}
