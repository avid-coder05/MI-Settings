...
public class DataUsageList extends DataUsageBaseFragment implements MobileDataEnabledListener.Client {
    ...
    public void bindStats(NetworkStats networkStats, int[] iArr) {
        ...
        while (true) {
            ...
            if (!UserHandle.isApp(uid)) {
                i = uid;
                if (i != -4 && i != -5 && i != 1061) {
                    i = VipService.VIP_SERVICE_FAILURE;
                }
                i2 = 2;
    ...
    public void onCreate(Bundle bundle) {
        ...
        Preference findPreference = FeatureFlagUtils.isEnabled(getContext(), "settings_provider_model") ? findPreference("operator_warning") : findPreference("non_carrier_data_usage_warning");
    ...
    void processArgument() {
        ...
        if (arguments != null) {
            this.mSubId = arguments.getInt(MiuiHeDuoHaoUtil.SUB_ID, -1);
