...
public final class DataUsageUtils extends com.android.settingslib.net.DataUsageUtils {
    ...
    public static CharSequence formatDataUsage(Context context, long j) {
        ...
        return BidiFormatter.getInstance().unicodeWrap(context.getString(17040307, formatBytes.value, formatBytes.units));
    }
    ...
    public static NetworkTemplate getDefaultTemplate(Context context, int i) {
        return (SubscriptionManager.isValidSubscriptionId(i) && hasMobileData(context)) ? DataUsageLib.getMobileTemplate(context, i) : hasWifiRadio(context) ? NetworkTemplate.buildTemplateWifi(NetworkTemplate.WIFI_NETWORKID_ALL, (String) null) : NetworkTemplate.buildTemplateEthernet();
    }
