...
public class ChartDataUsagePreference extends Preference {
    ...
    private void bindNetworkPolicy(UsageView usageView, NetworkPolicy networkPolicy, int i) {
        ...
        if (j2 != -1) {
            usageView.setDividerLoc((int) (j2 / PlaybackStateCompat.ACTION_SET_SHUFFLE_MODE_ENABLED));
            float f = ((float) (networkPolicy.warningBytes / PlaybackStateCompat.ACTION_SET_SHUFFLE_MODE_ENABLED)) / i;
    ...
    public /* synthetic */ void lambda$getDensedStatsData$0(List list, Integer num, List list2) {
        ...
        }).min().getAsLong(), list2.stream().mapToLong(new ToLongFunction() { // from class: com.android.settings.datausage.ChartDataUsagePreference$$ExternalSyntheticLambda3
            @Override // java.util.function.ToLongFunction
            public final long applyAsLong(Object obj) {
    ...
    private void setupContentDescription(UsageView usageView, List<NetworkCycleData> list) {
        ...
        for (DataUsageSummaryNode dataUsageSummaryNode : getDensedStatsData(list)) {
            ...
            sb.append(String.format(";%s %d%%", (!dataUsageSummaryNode.isFromMultiNode() || dataUsagePercentage == 100) ? DateUtils.formatDateTime(context, dataUsageSummaryNode.getStartTime(), 65552) : DateUtils.formatDateRange(context, dataUsageSummaryNode.getStartTime(), dataUsageSummaryNode.getEndTime(), 65552), Integer.valueOf(dataUsagePercentage)));
        }
        usageView.setContentDescription(sb);
    }
    ...
    void calcPoints(UsageView usageView, List<NetworkCycleData> list) {
        ...
        for (NetworkCycleData networkCycleData : list) {
            ...
            int i2 = (int) (j / PlaybackStateCompat.ACTION_SET_SHUFFLE_MODE_ENABLED);
            sparseIntArray.put(i, i2);
            sparseIntArray.put(toInt(endTime - this.mStart), i2);
        }
        if (sparseIntArray.size() > 1) {
    ...
    List<DataUsageSummaryNode> getDensedStatsData(List<NetworkCycleData> list) {
        ...
        long max = Math.max(1L, list.stream().mapToLong(new ToLongFunction() { // from class: com.android.settings.datausage.ChartDataUsagePreference$$ExternalSyntheticLambda5
            @Override // java.util.function.ToLongFunction
            public final long applyAsLong(Object obj) {
        ...
        Map map = (Map) arrayList.stream().collect(Collectors.groupingBy(new Function() { // from class: com.android.settings.datausage.ChartDataUsagePreference$$ExternalSyntheticLambda1
        ...
        map.forEach(new BiConsumer() { // from class: com.android.settings.datausage.ChartDataUsagePreference$$ExternalSyntheticLambda0
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
                ChartDataUsagePreference.this.lambda$getDensedStatsData$0(arrayList2, (Integer) obj, (List) obj2);
            }
        });
        return (List) arrayList2.stream().sorted(Comparator.comparingInt(new ToIntFunction() { // from class: com.android.settings.datausage.ChartDataUsagePreference$$ExternalSyntheticLambda2
    ...
    public int getTop() {
        ...
        return (int) (Math.max(totalUsage, networkPolicy != null ? Math.max(networkPolicy.limitBytes, networkPolicy.warningBytes) : 0L) / PlaybackStateCompat.ACTION_SET_SHUFFLE_MODE_ENABLED);
    }
