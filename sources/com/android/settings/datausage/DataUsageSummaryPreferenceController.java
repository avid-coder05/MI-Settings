...
public class DataUsageSummaryPreferenceController extends TelephonyBasePreferenceController implements PreferenceControllerMixin, LifecycleObserver, OnStart {
    ...
    Intent createManageSubscriptionIntent(int i) {
        ...
        if (this.mContext.getPackageManager().queryIntentActivities(intent, SearchUpdater.GOOGLE).isEmpty()) {
            return null;
        }
        return intent;
    }
    ...
    public void onStart() {
        ...
        this.mEntityHeaderController.setRecyclerView(null, this.mLifecycle);
    }
