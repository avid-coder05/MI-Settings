...
public class PreventRingingParentPreferenceController extends TogglePreferenceController implements LifecycleObserver, OnStart, OnStop {
    ...
    private boolean isVolumePowerKeyChordSetToHush() {
        return Settings.Global.getInt(this.mContext.getContentResolver(), "key_chord_power_volume_up", this.mContext.getResources().getInteger(17694836)) == 1;
    }
    ...
    public int getAvailabilityStatus() {
        if (this.mContext.getResources().getBoolean(17891704)) {
            ...
            return this.mContext.getResources().getBoolean(17891589) ? 5 : 3;
        }
        return 3;
    }
    ...
    public void updateState(Preference preference) {
        ...
        int i = Settings.Secure.getInt(this.mContext.getContentResolver(), "volume_hush_gesture", 1);
        if (isVolumePowerKeyChordSetToHush()) {
            text = i != 1 ? i != 2 ? this.mContext.getText(R.string.switch_off_text) : this.mContext.getText(R.string.prevent_ringing_option_mute_summary) : this.mContext.getText(R.string.prevent_ringing_option_vibrate_summary);
