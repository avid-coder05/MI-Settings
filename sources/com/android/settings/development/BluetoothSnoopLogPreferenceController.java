...
public class BluetoothSnoopLogPreferenceController extends DeveloperOptionsPreferenceController implements Preference.OnPreferenceChangeListener, PreferenceControllerMixin {
    ...
    public void onDeveloperOptionsSwitchDisabled() {
        ...
        ((DropDownPreference) this.mPreference).setValue(this.mListValues[getDefaultModeIndex()]);
        ((DropDownPreference) this.mPreference).setSummary(this.mListEntries[getDefaultModeIndex()]);
    }
    ...
    public void updateState(Preference preference) {
        ...
        dropDownPreference.setValue(this.mListValues[defaultModeIndex]);
        dropDownPreference.setSummary(this.mListEntries[defaultModeIndex]);
    }
}
