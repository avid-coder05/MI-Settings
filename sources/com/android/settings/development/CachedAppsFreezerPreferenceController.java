...
public class CachedAppsFreezerPreferenceController extends DeveloperOptionsPreferenceController implements Preference.OnPreferenceChangeListener, PreferenceControllerMixin {
    ...
    public boolean onPreferenceChange(Preference preference, Object obj) {
        ...
        new AlertDialog.Builder(this.mContext, R.style.AlertDialog_Theme_DayNight).setMessage(R.string.cached_apps_freezer_reboot_dialog_text).setPositiveButton(17039370, getRebootDialogOkListener(obj)).setNegativeButton(17039360, getRebootDialogCancelListener()).create().show();
        return true;
    }
