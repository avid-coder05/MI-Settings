...
public class RegulatoryInfoDisplayActivity extends Activity implements DialogInterface.OnDismissListener {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:13:0x0042, code lost:
        ...
        if (r4.getIntrinsicHeight() > 2) goto L16;
     */
    ...
    */
    protected void onCreate(android.os.Bundle r9) {
        /*
            r8 = this;
            super.onCreate(r9)
            miuix.appcompat.app.AlertDialog$Builder r9 = new miuix.appcompat.app.AlertDialog$Builder
            r9.<init>(r8)
            int r0 = com.android.settings.R.string.regulatory_labels
            miuix.appcompat.app.AlertDialog$Builder r9 = r9.setTitle(r0)
            miuix.appcompat.app.AlertDialog$Builder r9 = r9.setOnDismissListener(r8)
            r0 = 17039370(0x104000a, float:2.42446E-38)
            r1 = 0
            miuix.appcompat.app.AlertDialog$Builder r9 = r9.setPositiveButton(r0, r1)
        ...
        L77:
            ...
            if (r0 <= 0) goto L93
            r9.setMessage(r2)
            miuix.appcompat.app.AlertDialog r8 = r9.show()
