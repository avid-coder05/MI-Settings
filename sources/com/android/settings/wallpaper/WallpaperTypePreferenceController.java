...
public class WallpaperTypePreferenceController extends BasePreferenceController implements LifecycleObserver, OnStart {
    ...
    private void populateWallpaperTypes() {
        ...
        List<ResolveInfo> queryIntentActivities = packageManager.queryIntentActivities(intent, SearchUpdater.GOOGLE);
        ...
        for (ResolveInfo resolveInfo : queryIntentActivities) {
            ...
            Intent addFlags = new Intent(intent).addFlags(MiuiWindowManager$LayoutParams.EXTRA_FLAG_IS_PIP_SCREEN_PROJECTION);
