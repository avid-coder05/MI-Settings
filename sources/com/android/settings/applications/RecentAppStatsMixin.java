...
public class RecentAppStatsMixin implements Comparator<UsageStats>, LifecycleObserver, OnStart {
    ...
    static {
        ...
        arraySet.addAll(Arrays.asList(ThemeResources.FRAMEWORK_PACKAGE, "com.android.phone", "com.android.settings", ThemeResources.SYSTEMUI_NAME, "com.android.providers.calendar", "com.android.providers.media"));
    }
    ...
    public void loadDisplayableRecentApps(int i) {
        ...
        calendar.add(6, -1);
        List<UsageStats> arrayList = this.mPowerManager.isPowerSaveMode() ? new ArrayList<>() : this.mUsageStatsManager.queryUsageStats(4, this.mCalendar.getTimeInMillis(), System.currentTimeMillis());
        ArrayMap arrayMap = new ArrayMap();
        int size = arrayList.size();
        int i2 = 0;
        for (int i3 = 0; i3 < size; i3++) {
            UsageStats usageStats = arrayList.get(i3);
