...
public class ScaryWarningDialogFragment extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        String string2 = getResources().getString(R.string.zen_access_warning_dialog_title, arguments.getString(MiCloudSmsCmd.TYPE_LOCATION));
        ...
        AlertDialog create = new AlertDialog.Builder(getContext()).setMessage(string3).setTitle(string2).setPositiveButton(R.string.allow, new DialogInterface.OnClickListener() { // from class: com.android.settings.applications.specialaccess.zenaccess.ScaryWarningDialogFragment$$ExternalSyntheticLambda1
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                ScaryWarningDialogFragment.this.lambda$onCreateDialog$0(string, dialogInterface, i);
            }
        }).setNegativeButton(R.string.deny, new DialogInterface.OnClickListener() { // from class: com.android.settings.applications.specialaccess.zenaccess.ScaryWarningDialogFragment$$ExternalSyntheticLambda0
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                ScaryWarningDialogFragment.this.lambda$onCreateDialog$1(dialogInterface, i);
            }
        }).create();
