...
public class NotificationAccessDetails extends DashboardFragment {
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (i == 102) {
            if (!(i2 == -1) || (componentName = this.mComponentName) == null) {
                return;
            }
    ...
    public void onAttach(Context context) {
        ...
        if (this.mComponentName == null && intent != null && (stringExtra = intent.getStringExtra("android.provider.extra.NOTIFICATION_LISTENER_COMPONENT_NAME")) != null) {
            ...
            if (unflattenFromString != null) {
                getArguments().putString(FunctionColumns.PACKAGE, this.mComponentName.getPackageName());
            }
        }
    ...
    protected void retrieveAppEntry() {
        ...
        this.mPackageName = arguments != null ? arguments.getString(FunctionColumns.PACKAGE) : null;
        Intent intent = arguments == null ? getIntent() : (Intent) arguments.getParcelable(PaymentManager.KEY_INTENT);
    ...
    protected void setIntentAndFinish(boolean z) {
