...
public class ProcessStatsDetail extends SettingsPreferenceFragment {
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        FragmentActivity activity = getActivity();
        EntityHeaderController packageName = EntityHeaderController.newInstance(activity, this, null).setRecyclerView(null, getLifecycle()).setIcon(this.mApp.mUiTargetApp != null ? IconDrawableFactory.newInstance(activity).getBadgedIcon(this.mApp.mUiTargetApp) : new ColorDrawable(0)).setLabel(this.mApp.mUiLabel).setPackageName(this.mApp.mPackage);
