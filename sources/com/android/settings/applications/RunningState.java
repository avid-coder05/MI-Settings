...
public class RunningState {
    ...
    public static class ProcessItem extends BaseItem {
        ...
        public void ensureLabel(PackageManager packageManager) {
            ...
            try {
                ApplicationInfo applicationInfo = packageManager.getApplicationInfo(this.mProcessName, MiuiWindowManager$LayoutParams.EXTRA_FLAG_ACQUIRES_SLEEP_TOKEN);
            ...
            if (packagesForUid == null) {
                Log.e("RunningState", "getPackagesForUid return null for uid: " + this.mUid);
                packagesForUid = new String[0];
            }
            if (packagesForUid.length == 1) {
                try {
                    ApplicationInfo applicationInfo2 = packageManager.getApplicationInfo(packagesForUid[0], MiuiWindowManager$LayoutParams.EXTRA_FLAG_ACQUIRES_SLEEP_TOKEN);
            ...
            try {
                if (packagesForUid.length == 0) {
                    Log.e("RunningState", "pkgs is empty");
                    return;
                }
                ApplicationInfo applicationInfo4 = packageManager.getApplicationInfo(packagesForUid[0], MiuiWindowManager$LayoutParams.EXTRA_FLAG_ACQUIRES_SLEEP_TOKEN);
        ...
        boolean updateService(Context context, ActivityManager.RunningServiceInfo runningServiceInfo) {
            ...
            if (serviceItem == null) {
                ...
                try {
                    ServiceInfo serviceInfo = ActivityThread.getPackageManager().getServiceInfo(runningServiceInfo.service, (int) MiuiWindowManager$LayoutParams.EXTRA_FLAG_ACQUIRES_SLEEP_TOKEN, UserHandle.getUserId(runningServiceInfo.uid));
    ...
    /* JADX WARN: Removed duplicated region for block: B:372:0x070c A[LOOP:25: B:370:0x0704->B:372:0x070c, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:395:0x071d A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public boolean update(android.content.Context r25, android.app.ActivityManager r26) {
        /*
