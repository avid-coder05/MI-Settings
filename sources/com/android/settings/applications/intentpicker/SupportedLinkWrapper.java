...
public class SupportedLinkWrapper implements Comparable {
    ...
    private String getLastPackageLabel(final Context context, final boolean z) {
        return (String) ((List) this.mOwnerSet.stream().filter(new Predicate() { // from class: com.android.settings.applications.intentpicker.SupportedLinkWrapper$$ExternalSyntheticLambda1
        ...
        }).filter(new Predicate() { // from class: com.android.settings.applications.intentpicker.SupportedLinkWrapper$$ExternalSyntheticLambda3
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
    ...
    private void init(Context context) {
        if (this.mOwnerSet.size() > 0) {
            long count = this.mOwnerSet.stream().filter(new Predicate() { // from class: com.android.settings.applications.intentpicker.SupportedLinkWrapper$$ExternalSyntheticLambda2
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
