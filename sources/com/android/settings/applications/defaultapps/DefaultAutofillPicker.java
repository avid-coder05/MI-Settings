...
public class DefaultAutofillPicker extends DefaultAppPickerFragment {
    ...
    protected CharSequence getConfirmationMessage(CandidateInfo candidateInfo) {
        if (candidateInfo != null) {
            if (candidateInfo.getKey() == null || !candidateInfo.getKey().contains("com.miui.contentcatcher")) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (activity != null && activity.getIntent().getStringExtra(ExtraNetwork.FIREWALL_PACKAGE_NAME) != null) {
    ...
    protected boolean setDefaultKey(String str) {
        ...
        if (activity == null || (stringExtra = activity.getIntent().getStringExtra(ExtraNetwork.FIREWALL_PACKAGE_NAME)) == null) {
            return true;
        }
