...
public class LocationSettingsFooterPreferenceController extends LocationBasePreferenceController {
    ...
    private void openLocationLearnMoreLink() {
        ...
        Intent helpIntent = HelpUtils.getHelpIntent(context, context.getString(R.string.location_settings_footer_learn_more_link), "");
        helpIntent.setFlags(268435456);
        this.mFragment.startActivityForResult(helpIntent, 0);
    }
