...
public class AnimationParticle {
    ...
    private void drawDot(Canvas canvas) {
        canvas.drawCircle(this.mBounds.exactCenterX() + (((r0.right - this.mBounds.exactCenterX()) - this.mBorderWidth) * ((float) Math.cos(this.mCurrentAngle))), this.mBounds.exactCenterY() + (((r0.bottom - this.mBounds.exactCenterY()) - this.mBorderWidth) * ((float) Math.sin(this.mCurrentAngle))), this.mCurrentSize, this.mPaint);
    }
