...
public class CaptionAppearanceFragment extends DashboardFragment implements Preference.OnPreferenceChangeListener, ListDialogPreference.OnValueChangedListener {
    ...
    private void initializeAllPreferences() {
        ...
        ImageView imageView = (ImageView) layoutPreference.findViewById(R.id.preview_image);
        if (imageView != null && MiuiAboutPhoneUtils.getInstance(getActivity()).isMIUILite()) {
            imageView.setImageBitmap(MiuiUtils.drawableToBitmap(getActivity(), R.drawable.caption_background));
        }
    ...
    private int mergeColorOpacity(ColorPreference colorPreference, ColorPreference colorPreference2) {
        ...
        return !CaptioningManager.CaptionStyle.hasColor(value) ? 16776960 | Color.alpha(value2) : value == 0 ? Color.alpha(value2) : (value & 16777215) | (value2 & (-16777216));
    }
