...
public class MagnificationNavbarPreferenceController extends TogglePreferenceController {
    ...
    public CharSequence getSummary() {
        return this.mContext.getText(this.mIsFromSUW ? R.string.accessibility_screen_magnification_navbar_short_summary : isChecked() ? R.string.accessibility_feature_state_on : R.string.accessibility_feature_state_off);
    }
