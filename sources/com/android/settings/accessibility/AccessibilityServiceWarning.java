...
public class AccessibilityServiceWarning {
    ...
    private static View createEnableDialogContentView(Context context, AccessibilityServiceInfo accessibilityServiceInfo, View.OnClickListener onClickListener, final UninstallActionPerformer uninstallActionPerformer) {
        ...
        ((ImageView) inflate.findViewById(R.id.permissionDialog_icon)).setImageDrawable(accessibilityServiceInfo.getResolveInfo().getIconResource() == 0 ? ContextCompat.getDrawable(context, R.drawable.ic_accessibility_generic) : accessibilityServiceInfo.getResolveInfo().loadIcon(context.getPackageManager()));
        ...
        Button button2 = (Button) inflate.findViewById(R.id.permission_enable_deny_button);
        button.setOnClickListener(onClickListener);
        button.setOnTouchListener(filterTouchListener);
        button2.setOnClickListener(onClickListener);
        Button button3 = (Button) inflate.findViewById(R.id.permission_enable_uninstall_button);
        if (!AccessibilityUtil.isSystemApp(accessibilityServiceInfo)) {
            button3.setVisibility(0);
            button3.setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.accessibility.AccessibilityServiceWarning$$ExternalSyntheticLambda0
    ...
    public static /* synthetic */ boolean lambda$static$0(View view, MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 1) {
            Toast.makeText(view.getContext(), MiuiSettings.System.isTouchAssistantEnabledForUser(view.getContext(), view.getContext().getUserId(), false) ? R.string.miui_touch_filtered_touchassistant_warning : R.string.miui_touch_filtered_warning, 0).show();
        }
        return true;
    }
}
