...
public class SettingsSliceProvider extends SliceProvider {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: startBackgroundWorker  reason: merged with bridge method [inline-methods] and merged with bridge method [inline-methods] */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: stopBackgroundWorker  reason: merged with bridge method [inline-methods] */
    ...
    /* renamed from: loadSlice  reason: merged with bridge method [inline-methods] */
    ...
    public PendingIntent onCreatePermissionRequest(Uri uri, String str) {
        return PendingIntent.getActivity(getContext(), 0, new Intent(SplitUtils.SETTINGS_MAIN_INTENT).setPackage("com.android.settings"), MiuiWindowManager$LayoutParams.EXTRA_FLAG_FULLSCREEN_BLURSURFACE);
    }
    ...
    public void shutdown() {
        ThreadUtils.postOnMainThread(new Runnable() { // from class: com.android.settings.slices.SettingsSliceProvider$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
