...
public class CustomSliceRegistry {
    ...
    static {
        Uri build = new Uri.Builder().scheme("content").authority("com.android.settings.slices").appendPath(PaymentManager.KEY_INTENT).appendPath(ScreenTimeoutPreferenceController.PREF_NAME).build();
        CONTEXTUAL_ADAPTIVE_SLEEP_URI = build;
        Uri build2 = new Uri.Builder().scheme("content").authority("com.android.settings.slices").appendEncodedPath(PaymentManager.KEY_INTENT).appendPath(BatteryTipPreferenceController.PREF_NAME).build();
        BATTERY_FIX_SLICE_URI = build2;
        BLUETOOTH_URI = new Uri.Builder().scheme("content").authority("android.settings.slices").appendPath("action").appendPath(DeviceType.BLUETOOTH).build();
        ...
        Uri build8 = new Uri.Builder().scheme("content").authority("com.android.settings.slices").appendEncodedPath(PaymentManager.KEY_INTENT).appendPath("low_storage").build();
        ...
        WIFI_CALLING_URI = new Uri.Builder().scheme("content").authority("com.android.settings.slices").appendPath(PaymentManager.KEY_INTENT).appendPath("wifi_calling").build();
        ...
        MEDIA_OUTPUT_INDICATOR_SLICE_URI = new Uri.Builder().scheme("content").authority("com.android.settings.slices").appendPath(PaymentManager.KEY_INTENT).appendPath("media_output_indicator").build();
