...
public class SimSelectNotification extends BroadcastReceiver {
    ...
    private void cancelEnableMmsNotification(Context context) {
        ((NotificationManager) context.getSystemService(ThemeManagerConstants.COMPONENT_CODE_NOTIFICATION)).cancel(2);
    }
    ...
    public static void cancelSimSelectNotification(Context context) {
        ((NotificationManager) context.getSystemService(ThemeManagerConstants.COMPONENT_CODE_NOTIFICATION)).cancel(1);
    }
    ...
    private void startSimSelectDialogIfNeeded(Context context, Intent intent) {
        ...
        if (intExtra == 4) {
            ...
            Intent intent4 = new Intent(context, SimDialogActivity.class);
