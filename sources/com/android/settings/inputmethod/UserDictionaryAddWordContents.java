...
public class UserDictionaryAddWordContents {
    ...
    public UserDictionaryAddWordContents(View view, Bundle bundle) {
        ...
        this.mMode = bundle.getInt(ExtraTelephony.FirewallLog.MODE);
    ...
    private boolean hasWord(String str, Context context) {
        Cursor query = "".equals(this.mLocale) ? context.getContentResolver().query(UserDictionary.Words.CONTENT_URI, HAS_WORD_PROJECTION, "word=? AND locale is null", new String[]{str}, null) : context.getContentResolver().query(UserDictionary.Words.CONTENT_URI, HAS_WORD_PROJECTION, "word=? AND locale=?", new String[]{str, this.mLocale}, null);
        if (query == null) {
            return false;
        }
        try {
