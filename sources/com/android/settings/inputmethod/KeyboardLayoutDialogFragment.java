...
public class KeyboardLayoutDialogFragment extends InstrumentedDialogFragment implements InputManager.InputDeviceListener, LoaderManager.LoaderCallbacks<Keyboards> {
    ...
    public static final class KeyboardLayoutAdapter extends ArrayAdapter<KeyboardLayout> {
        ...
        private View inflateOneLine(View view, ViewGroup viewGroup, String str, boolean z) {
            if (view == null || isTwoLine(view)) {
                view = this.mInflater.inflate(R.layout.miuix_appcompat_select_dialog_singlechoice, viewGroup, false);
        ...
        private View inflateTwoLine(View view, ViewGroup viewGroup, String str, String str2, boolean z) {
            if (view == null || !isTwoLine(view)) {
                view = this.mInflater.inflate(R.layout.miui_simple_list_item_2_single_choice, viewGroup, false);
                setTwoLine(view, true);
            }
            TextView textView = (TextView) view.findViewById(16908308);
            TextView textView2 = (TextView) view.findViewById(16908309);
            RadioButton radioButton = (RadioButton) view.findViewById(ResourceMapper.resolveReference(getContext().getResources(), R.id.android_radio));
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            return str2.isEmpty() ? inflateOneLine(view, viewGroup, str3, z) : inflateTwoLine(view, viewGroup, str3, str2, z);
        }
    ...
    private void updateSwitchHintVisibility() {
        ...
        findViewById.setVisibility(this.mAdapter.getCount() > 1 ? 0 : 8);
    }
