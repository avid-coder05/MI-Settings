...
public class NightDisplaySettings extends DashboardFragment implements NightDisplayListener.Callback {
    ...
    public Dialog onCreateDialog(final int i) {
        if (i == 0 || i == 1) {
            LocalTime nightDisplayCustomStartTime = i == 0 ? this.mColorDisplayManager.getNightDisplayCustomStartTime() : this.mColorDisplayManager.getNightDisplayCustomEndTime();
            Context context = getContext();
            ...
            }, nightDisplayCustomStartTime.getHour(), nightDisplayCustomStartTime.getMinute(), DateFormat.is24HourFormat(context));
        }
