...
public class MiuiNfcDndModeController extends AbstractPreferenceController implements LifecycleObserver, Preference.OnPreferenceChangeListener {
    private NfcAdapter mNfcAdapter;

    public MiuiNfcDndModeController(Context context, Lifecycle lifecycle) {
        super(context);
