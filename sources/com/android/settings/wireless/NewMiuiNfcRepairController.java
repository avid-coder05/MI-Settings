...
public class NewMiuiNfcRepairController extends AbstractPreferenceController implements DialogInterface.OnDismissListener, Preference.OnPreferenceClickListener, LifecycleObserver, OnCreate, OnSaveInstanceState, OnResume, OnPause, OnDestroy {
    ...
    public NewMiuiNfcRepairController(Context context, Lifecycle lifecycle) {
        super(context);
        this.mStartTime = 0L;
        this.mState = 0;
        this.mHandler = new Handler(Looper.getMainLooper()) { // from class: com.android.settings.wireless.NewMiuiNfcRepairController.1
            @Override // android.os.Handler
            public void handleMessage(Message message) {
                Log.i("NewMiuiNfcRepairController", "handleMessage: " + message.what);
                NewMiuiNfcRepairController.this.mHandler.removeMessages(1);
                if (message.what != 0) {
                    NewMiuiNfcRepairController.this.updateState(5);
                } else {
                    NewMiuiNfcRepairController.this.updateState(4);
                }
                if (NewMiuiNfcRepairController.this.mDialog != null) {
                    NewMiuiNfcRepairController.this.mWhichBtn = -1;
                    NewMiuiNfcRepairController.this.mDialog.dismiss();
                    NewMiuiNfcRepairController.this.mDialog = null;
                }
            }
        };
        this.mReceiver = new BroadcastReceiver() { // from class: com.android.settings.wireless.NewMiuiNfcRepairController.2
            @Override // android.content.BroadcastReceiver
            public void onReceive(Context context2, Intent intent) {
                if ("com.android.nfc.action.repair.rsp".equals(intent.getAction())) {
                    ((AbstractPreferenceController) NewMiuiNfcRepairController.this).mContext.unregisterReceiver(NewMiuiNfcRepairController.this.mReceiver);
                    NewMiuiNfcRepairController.this.mHandler.sendEmptyMessage(!intent.getBooleanExtra("success", false));
                }
            }
        };
        this.mWhichBtn = -2;
        this.mRebootListener = new DialogInterface.OnClickListener() { // from class: com.android.settings.wireless.NewMiuiNfcRepairController$$ExternalSyntheticLambda0
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                NewMiuiNfcRepairController.this.lambda$new$0(dialogInterface, i);
            }
        };
        this.mActionListener = new DialogInterface.OnClickListener() { // from class: com.android.settings.wireless.NewMiuiNfcRepairController$$ExternalSyntheticLambda2
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                NewMiuiNfcRepairController.this.lambda$new$1(dialogInterface, i);
            }
        };
        this.mInquiryListener = new DialogInterface.OnClickListener() { // from class: com.android.settings.wireless.NewMiuiNfcRepairController$$ExternalSyntheticLambda1
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                NewMiuiNfcRepairController.this.lambda$new$2(dialogInterface, i);
            }
        };
    ...
    public void updateState(int i) {
        Log.d("NewMiuiNfcRepairController", "updateState: old state=" + this.mState + ", new state=" + i);
        this.mState = i;
    }
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        Log.d("NewMiuiNfcRepairController", "displayPreference: " + this);
    ...
    public boolean isAvailable() {
        return SettingsFeatures.hasNfcRepairFeature(this.mContext);
    }
    ...
    void nextDialogShow() {
        ...
        this.mWhichBtn = -2;
        Log.d("NewMiuiNfcRepairController", "nextDialogShow: " + this.mState);
        int i6 = this.mState;
        int i7 = 17039360;
        if (i6 != 1) {
            if (i6 == 2) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        Log.d("NewMiuiNfcRepairController", "onCreate: " + this.mState);
    }

    @Override // com.android.settingslib.core.lifecycle.events.OnDestroy
    public void onDestroy() {
        Log.d("NewMiuiNfcRepairController", "onDestroy: " + this);
        if (this.mState == 3) {
    ...
    public boolean onPreferenceClick(Preference preference) {
        Log.d("NewMiuiNfcRepairController", "trigger inquiry");
        if (Utils.isMonkeyRunning()) {
            Log.i("NewMiuiNfcRepairController", "Ingore, Monkey running...");
            return true;
        }
        updateState(1);
        nextDialogShow();
    ...
    public void onSaveInstanceState(Bundle bundle) {
        Log.i("NewMiuiNfcRepairController", "onSaveInstanceState: " + this.mState + ", StartTime=" + this.mStartTime);
    ...
    void rebootPhone() {
        try {
            Log.d("NewMiuiNfcRepairController", "rebootPhone: " + this.mState);
            ((PowerManager) this.mContext.getSystemService("power")).reboot("OneTouchRepair...");
        } catch (Exception e) {
            Log.e("NewMiuiNfcRepairController", "RebootPhone fail: " + e);
        }
    }

    void repairNFC() {
        Log.d("NewMiuiNfcRepairController", "repairNFC: " + this.mState);
        long j = 0;
        try {
            ...
            Log.e("NewMiuiNfcRepairController", "RepairNFC fail: " + e);
