...
public final class R$styleable {
    ...
    public static final int CustomA11yHapticView_bg = 0;
    public static final int CustomA11yHapticView_radius = 1;
    public static final int CustomA11yHapticView_text = 2;
    public static final int DialogListPreference_summaries = 0;
    ...
    public static final int GradientsCorner_gradient_radius = 0;
    public static final int GradientsList_gradient_colors = 0;
    public static final int GradientsList_gradient_positions = 1;
    public static final int ImagePreference_image = 0;
    public static final int ImagePreference_second_title = 1;
    public static final int LabelPreferenceWithBg_backgroundRes = 0;
    public static final int LabelPreferenceWithBg_first = 1;
    ...
    public static final int MultiGradientDrawable_bottom = 0;
    public static final int MultiGradientDrawable_left = 1;
    public static final int MultiGradientDrawable_right = 2;
    public static final int MultiGradientDrawable_top = 3;
    ...
    public static final int Preference_searchable = 33;
    public static final int Preference_unavailableSliceSubtitle = 40;
    public static final int RepeatPreferenceWithBg_backgroundRes = 0;
    public static final int RepeatPreferenceWithBg_last = 1;
    public static final int RestrictedPreferenceStyle_iconNeedPadding = 0;
    public static final int RestrictedPreferenceStyle_isCardStyle = 1;
    public static final int RestrictedPreferenceStyle_showBackground = 2;
    public static final int RestrictedPreferenceStyle_showRightArrow = 3;
    public static final int RestrictedPreferenceStyle_showTouchAnim = 4;
    public static final int SettingsStatusCard_cardBackground = 0;
    public static final int SettingsStatusCard_cardIcon = 1;
    public static final int SettingsStatusCard_cardTitle = 2;
    public static final int SettingsStatusCard_cardTitleColor = 3;
    public static final int SettingsStatusCard_cardValue = 4;
    public static final int SettingsStatusCard_cardValueColor = 5;
    ...
    public static final int VisualCheckBoxPreference_negativeContent = 0;
    public static final int VisualCheckBoxPreference_negativeDescription = 1;
    public static final int VisualCheckBoxPreference_negativeTitle = 2;
    public static final int VisualCheckBoxPreference_positiveContent = 3;
    public static final int VisualCheckBoxPreference_positiveDescription = 4;
    public static final int VisualCheckBoxPreference_positiveTitle = 5;
    public static final int VpnCheckBox_checkbox_title = 0;
    public static final int VpnSpinner_spinner_entries = 0;
    public static final int VpnSpinner_spinner_title = 1;
