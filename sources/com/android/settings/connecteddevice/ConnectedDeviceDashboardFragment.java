...
public class ConnectedDeviceDashboardFragment extends DashboardFragment {
    ...
    boolean isAlwaysDiscoverable(String str, String str2) {
        ...
        return TextUtils.equals("com.android.settings", str) || TextUtils.equals(ThemeResources.SYSTEMUI_NAME, str);
    }
    ...
    public void onAttach(Context context) {
        ...
        if (DEBUG) {
            Log.d("ConnectedDeviceFrag", "onAttach() calling package name is : " + callingAppPackageName + ", action : " + action);
        }
        ...
        ((DiscoverableFooterPreferenceController) use(DiscoverableFooterPreferenceController.class)).setAlwaysDiscoverable(isAlwaysDiscoverable(callingAppPackageName, action));
    }
}
