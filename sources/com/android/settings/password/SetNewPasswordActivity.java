...
public class SetNewPasswordActivity extends Activity implements SetNewPasswordController.Ui {
    ...
    private void logSetNewPasswordIntent() {
        String callingAppPackageName = PasswordUtils.getCallingAppPackageName(getActivityToken());
        int intExtra = (getIntent().hasExtra("android.app.extra.PASSWORD_COMPLEXITY") ? getIntent().getIntExtra("android.app.extra.PASSWORD_COMPLEXITY", 0) : Integer.MIN_VALUE) | (getIntent().getBooleanExtra("android.app.extra.DEVICE_PASSWORD_REQUIREMENT_ONLY", false) ? SearchUpdater.SIM : 0);
    ...
    public void launchChooseLock(Bundle bundle) {
        Intent intent = Utils.isDeviceProvisioned(this) ^ true ? new Intent(this, SetUpMiuiSecurityChooseUnlock.class) : new Intent(this, MiuiSecurityChooseUnlock.class);
