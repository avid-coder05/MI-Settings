...
public class ChooseLockGeneric extends SettingsActivity {
    ...
    public static class ChooseLockGenericFragment extends SettingsPreferenceFragment {
        ...
        private int getResIdForFactoryResetProtectionWarningMessage() {
            ...
            return keyguardStoredPasswordQuality != 65536 ? (keyguardStoredPasswordQuality == 131072 || keyguardStoredPasswordQuality == 196608) ? (hasEnrolledFingerprints && z) ? R.string.unlock_disable_frp_warning_content_pin_face_fingerprint : hasEnrolledFingerprints ? R.string.unlock_disable_frp_warning_content_pin_fingerprint : z ? R.string.unlock_disable_frp_warning_content_pin_face : R.string.unlock_disable_frp_warning_content_pin : (keyguardStoredPasswordQuality == 262144 || keyguardStoredPasswordQuality == 327680 || keyguardStoredPasswordQuality == 393216 || keyguardStoredPasswordQuality == 524288) ? (hasEnrolledFingerprints && z) ? R.string.unlock_disable_frp_warning_content_password_face_fingerprint : hasEnrolledFingerprints ? R.string.unlock_disable_frp_warning_content_password_fingerprint : z ? R.string.unlock_disable_frp_warning_content_password_face : R.string.unlock_disable_frp_warning_content_password : (hasEnrolledFingerprints && z) ? R.string.unlock_disable_frp_warning_content_unknown_face_fingerprint : hasEnrolledFingerprints ? R.string.unlock_disable_frp_warning_content_unknown_fingerprint : z ? R.string.unlock_disable_frp_warning_content_unknown_face : R.string.unlock_disable_frp_warning_content_unknown : (hasEnrolledFingerprints && z) ? R.string.unlock_disable_frp_warning_content_pattern_face_fingerprint : hasEnrolledFingerprints ? R.string.unlock_disable_frp_warning_content_pattern_fingerprint : z ? R.string.unlock_disable_frp_warning_content_pattern_face : R.string.unlock_disable_frp_warning_content_pattern;
        }
