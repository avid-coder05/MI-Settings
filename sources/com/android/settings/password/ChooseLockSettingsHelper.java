...
public final class ChooseLockSettingsHelper {
    ...
    private void copyInternalExtras(Intent intent, Intent intent2) {
        ...
        if (stringExtra != null) {
            intent2.putExtra(ThemeManagerConstants.COMPONENT_CODE_MASK, stringExtra);
        }
    }
    ...
    private void copyOptionalExtras(Intent intent, Intent intent2) {
        ...
        intent2.addFlags(MiuiWindowManager$LayoutParams.EXTRA_FLAG_IS_NO_SCREENSHOT);
        intent2.addFlags(SearchUpdater.SIM);
    }
    ...
    private boolean launchConfirmationActivity(int i, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, boolean z, boolean z2, boolean z3, int i2, CharSequence charSequence4, boolean z4, boolean z5, boolean z6) {
        ...
        if (keyguardStoredPasswordQuality == 65536) {
            return launchConfirmationActivityOrFragment(i, charSequence, charSequence2, charSequence3, (z || z3) ? ConfirmLockPattern.InternalActivity.class : ConfirmLockPattern.class, TabletUtils.IS_TABLET ? ConfirmLockPattern.InternalActivity.getExtraFragmentName() : null, z, z2, z3, i2, charSequence4, z4, z5, z6);
            ...
            return launchConfirmationActivityOrFragment(i, charSequence, charSequence2, charSequence3, (z || z3) ? ConfirmLockPassword.InternalActivity.class : ConfirmLockPassword.class, TabletUtils.IS_TABLET ? ConfirmLockPattern.InternalActivity.getExtraFragmentName() : null, z, z2, z3, i2, charSequence4, z4, z5, z6);
        } else {
            return false;
        }
    }

    private boolean launchConfirmationActivityOrFragment(int i, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, Class<?> cls, String str, boolean z, boolean z2, boolean z3, int i2, CharSequence charSequence4, boolean z4, boolean z5, boolean z6) {
        ...
        if (TabletUtils.IS_TABLET && str != null) {
            intent.putExtra(":settings:show_fragment", str);
            this.mActivity.getFragmentManager();
            return true;
        }
        if (z2) {
            intent.addFlags(MiuiWindowManager$LayoutParams.EXTRA_FLAG_IS_PIP_SCREEN_PROJECTION);
