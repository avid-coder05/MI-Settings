...
public abstract class AbstractZenModeAutomaticRulePreferenceController extends AbstractZenModePreferenceController {
    ...
    public static ZenRuleInfo getRuleInfo(PackageManager packageManager, ComponentInfo componentInfo) {
        ...
        if (componentInfo != null && (bundle = componentInfo.metaData) != null) {
            ...
            String string = z ? bundle.getString("android.service.zen.automatic.ruleType") : bundle.getString("android.service.zen.automatic.ruleType");
            ...
            if (string != null && !string.trim().isEmpty() && settingsActivity != null) {
                ...
                zenRuleInfo.ruleInstanceLimit = z ? componentInfo.metaData.getInt("android.service.zen.automatic.ruleInstanceLimit", -1) : componentInfo.metaData.getInt("android.service.zen.automatic.ruleInstanceLimit", -1);
                return zenRuleInfo;
            }
        }
        return null;
    ...
    public static Intent getRuleIntent(String str, ComponentName componentName, String str2) {
        Intent putExtra = new Intent().addFlags(MiuiWindowManager$LayoutParams.EXTRA_FLAG_FULLSCREEN_BLURSURFACE).putExtra("android.service.notification.extra.RULE_ID", str2);
