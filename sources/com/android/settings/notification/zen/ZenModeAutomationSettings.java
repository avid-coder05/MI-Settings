...
public class ZenModeAutomationSettings extends ZenModeSettingsBase {
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        ...
        new AlertDialog.Builder(this.mContext).setTitle(R.string.zen_mode_delete_automatic_rules).setMultiChoiceItems(this.mDeleteDialogRuleNames, null, new DialogInterface.OnMultiChoiceClickListener() { // from class: com.android.settings.notification.zen.ZenModeAutomationSettings.2
