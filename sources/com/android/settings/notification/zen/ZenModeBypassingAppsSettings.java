...
public class ZenModeBypassingAppsSettings extends ZenModeSettingsBase {
    ...
    public static List<AbstractPreferenceController> buildPreferenceControllers(Context context, Application application, ObservablePreferenceFragment observablePreferenceFragment, NotificationBackend notificationBackend) {
        ArrayList arrayList = new ArrayList();
        arrayList.add(new ZenModeAllBypassingAppsPreferenceController(context, application, observablePreferenceFragment, notificationBackend));
        arrayList.add(new ZenModeAddBypassingAppsPreferenceController(context, application, observablePreferenceFragment, notificationBackend));
        return arrayList;
    }
