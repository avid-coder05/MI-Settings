...
public class ShowOnLockScreenNotificationPreferenceController extends AbstractPreferenceController implements PreferenceControllerMixin, Preference.OnPreferenceChangeListener {
    ...
    public CharSequence getSummary() {
        return (adminAllowsNotifications() && getLockscreenNotificationsEnabled()) ? !getLockscreenSilentNotificationsEnabled() ? this.mContext.getString(R.string.lock_screen_notifs_show_alerting) : this.mContext.getString(R.string.lock_screen_notifs_show_all) : this.mContext.getString(R.string.lock_screen_notifs_show_none);
    }
