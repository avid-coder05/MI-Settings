...
public class RecentConversationsPreferenceController extends AbstractPreferenceController {
    ...
    SubSettingLauncher getSubSettingLauncher(ConversationChannel conversationChannel, CharSequence charSequence) {
        ...
        bundle.putString(FunctionColumns.PACKAGE, conversationChannel.getShortcutInfo().getPackage());
    ...
    CharSequence getSummary(ConversationChannel conversationChannel) {
        return conversationChannel.getNotificationChannelGroup() == null ? conversationChannel.getNotificationChannel().getName() : this.mContext.getString(R.string.notification_conversation_summary, conversationChannel.getNotificationChannel().getName(), conversationChannel.getNotificationChannelGroup().getName());
    }
