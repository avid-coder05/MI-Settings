...
public class NotificationAccessConfirmationActivity extends Activity implements DialogInterface {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.mNm = (NotificationManager) getSystemService(ThemeManagerConstants.COMPONENT_CODE_NOTIFICATION);
        this.mComponentName = (ComponentName) getIntent().getParcelableExtra("component_name");
        this.mUserId = getIntent().getIntExtra(ExtraIntent.EXTRA_XIAOMI_ACCOUNT_USER_ID, -10000);
