...
public class AnomalyDetectionJobService extends JobService {
    ...
    public /* synthetic */ void lambda$onStartJob$0(JobParameters jobParameters) {
        ...
        while (dequeueWork != null) {
            BatteryDatabaseManager batteryDatabaseManager2 = batteryDatabaseManager;
            BatteryDatabaseManager batteryDatabaseManager3 = batteryDatabaseManager;
            JobWorkItem jobWorkItem = dequeueWork;
            saveAnomalyToDatabase(this, userManager, batteryDatabaseManager2, batteryUtils, batteryTipPolicy, powerAllowlistBackend, contentResolver, powerUsageFeatureProvider, metricsFeatureProvider, dequeueWork.getIntent().getExtras());
            try {
                completeWork(jobParameters, jobWorkItem);
                dequeueWork = dequeueWork(jobParameters);
                batteryDatabaseManager = batteryDatabaseManager3;
            } catch (IllegalArgumentException e) {
                Log.w("AnomalyDetectionService", "job was cancelled?", e);
                return;
            }
        }
    }
    ...
    int extractUidFromStatsDimensionsValue(StatsDimensionsValue statsDimensionsValue) {
        ...
        if (statsDimensionsValue.isValueType(7)) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (extractUidFromStatsDimensionsValue != -1) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:13:0x0068, code lost:
        ...
        if (android.provider.Settings.Global.getInt(r20, "app_auto_restriction_enabled", 1) == 1) goto L14;
     */
    /*
