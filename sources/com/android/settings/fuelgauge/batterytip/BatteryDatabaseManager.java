...
public class BatteryDatabaseManager {
    ...
    public synchronized boolean deleteAction(int i, int i2, String str) {
        return this.mDatabaseHelper.getWritableDatabase().delete("action", "action_type = ? AND uid = ? AND package_name = ? ", new String[]{String.valueOf(i), String.valueOf(i2), String.valueOf(str)}) != 0;
    }
    ...
    public synchronized boolean insertAction(int i, int i2, String str, long j) {
        ...
        contentValues.put(ExtraNetwork.FIREWALL_PACKAGE_NAME, str);
