...
public class MoreSettingsPreferenceController extends BasePreferenceController implements View.OnClickListener {
    ...
    public int getAvailabilityStatus() {
        ...
        return (this.mIntent == null || (queryIntentActivities = this.mContext.getPackageManager().queryIntentActivities(this.mIntent, 1048576)) == null || queryIntentActivities.isEmpty()) ? 3 : 0;
    }
    ...
    public void onClick(View view) {
        ...
        Intent flags = new Intent(this.mIntent).addCategory("android.intent.category.LAUNCHER").setFlags(MiuiWindowManager$LayoutParams.EXTRA_FLAG_FULLSCREEN_BLURSURFACE);
