...
public class AppRestrictionsFragment extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener, View.OnClickListener, Preference.OnPreferenceClickListener, AppRestrictionsHelper.OnDisableUiForPackageListener {
    ...
    private int mCustomRequestCode = VipService.VIP_SERVICE_FAILURE;
    ...
    public class RestrictionsResultReceiver extends BroadcastReceiver {
        ...
        private void assertSafeToStartCustomActivity(Intent intent) {
            ...
            ResolveInfo resolveActivity = AppRestrictionsFragment.this.mPackageManager.resolveActivity(intent, SearchUpdater.GOOGLE);
            ...
            if (parcelableArrayList != null && intent2 == null) {
                ...
                if (this.invokeIfCustom && AppRestrictionsFragment.this.isResumed()) {
                    try {
                        ...
                        Log.e(AppRestrictionsFragment.TAG, "Cannot start restrictionsIntent " + e);
    ...
    private boolean isAppEnabledForUser(PackageInfo packageInfo) {
        ...
        return (applicationInfo.flags & MiuiWindowManager$LayoutParams.EXTRA_FLAG_IS_NO_SCREENSHOT) != 0 && (applicationInfo.privateFlags & 1) == 0;
    }
    ...
    public void onRestrictionsReceived(AppRestrictionsPreference appRestrictionsPreference, ArrayList<RestrictionEntry> arrayList) {
        ...
        while (it.hasNext()) {
            ...
            androidx.preference.SwitchPreference switchPreference = null;
            int type = next.getType();
            if (type == 1) {
                androidx.preference.SwitchPreference switchPreference2 = new androidx.preference.SwitchPreference(getPrefContext());
            ...
            if (switchPreference != null) {
                ...
                switchPreference.setKey(appRestrictionsPreference.getKey().substring(4) + ExtraContacts.ConferenceCalls.SPLIT_EXPRESSION + next.getKey());
            ...
            if (str != null) {
                ...
                if (equals) {
                    ...
                    if (packageInfo != null && (!this.mRestrictedProfile || !isAppUnsupportedInRestrictedProfile(packageInfo))) {
                        ...
                        appRestrictionsPreference.setIcon(drawable != null ? drawable.mutate() : null);
    ...
    protected void init(Bundle bundle) {
        if (bundle != null) {
            this.mUser = new UserHandle(bundle.getInt(ExtraIntent.EXTRA_XIAOMI_ACCOUNT_USER_ID));
        } else {
            Bundle arguments = getArguments();
            if (arguments != null) {
                if (arguments.containsKey(ExtraIntent.EXTRA_XIAOMI_ACCOUNT_USER_ID)) {
                    this.mUser = new UserHandle(arguments.getInt(ExtraIntent.EXTRA_XIAOMI_ACCOUNT_USER_ID));
                }
        ...
        this.mIPm = IPackageManager.Stub.asInterface(ServiceManager.getService(FunctionColumns.PACKAGE));
        ...
        try {
            this.mSysPackageInfo = this.mPackageManager.getPackageInfo(ThemeResources.FRAMEWORK_PACKAGE, 64);
    ...
    public boolean onPreferenceChange(Preference preference, Object obj) {
        ...
        if (key == null || !key.contains(ExtraContacts.ConferenceCalls.SPLIT_EXPRESSION)) {
            return false;
        }
        StringTokenizer stringTokenizer = new StringTokenizer(key, ExtraContacts.ConferenceCalls.SPLIT_EXPRESSION);
    ...
    public void onSaveInstanceState(Bundle bundle) {
        ...
        bundle.putInt(ExtraIntent.EXTRA_XIAOMI_ACCOUNT_USER_ID, this.mUser.getIdentifier());
    }
}
