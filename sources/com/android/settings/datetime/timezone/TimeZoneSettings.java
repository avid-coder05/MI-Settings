...
public class TimeZoneSettings extends DashboardFragment {
    ...
    private void onZonePickerRequestResult(TimeZoneData timeZoneData, Intent intent) {
        ...
        if (DualClockHealper.isDualClockMode()) {
            DualClockHealper.saveTimeZone(getContext(), stringExtra, this.mSelectedTimeZoneId);
        } else {
    ...
    private void setSelectByRegion(boolean z) {
        ...
        if (timeZoneData != null) {
            if (!timeZoneData.getRegionIds().contains(localeRegionId)) {
                localeRegionId = null;
            }
    ...
    private void setupForCurrentTimeZone() {
        if (DualClockHealper.isDualClockMode()) {
            this.mSelectedTimeZoneId = DualClockHealper.getDualTimeZoneID(getContext());
        } else {
    ...
    private void startPickerFragment(Class<? extends BaseTimeZonePicker> cls, Bundle bundle, int i) {
        new SubSettingLauncher(getActivity()).setDestination(cls.getCanonicalName()).setArguments(bundle).setSourceMetricsCategory(getMetricsCategory()).setResultListener(this, i).launch();
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        DualClockHealper.initDualClockMode(getArguments());
    }
