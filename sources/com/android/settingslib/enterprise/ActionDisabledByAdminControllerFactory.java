...
public final class ActionDisabledByAdminControllerFactory {
    public static ActionDisabledByAdminController createInstance(Context context, String str, DeviceAdminStringProvider deviceAdminStringProvider, UserHandle userHandle) {
        return doesBiometricRequireParentalConsent(context, str) ? new BiometricActionDisabledByAdminController(deviceAdminStringProvider) : isFinancedDevice(context) ? new FinancedDeviceActionDisabledByAdminController(deviceAdminStringProvider) : new ManagedDeviceActionDisabledByAdminController(deviceAdminStringProvider, userHandle, ManagedDeviceActionDisabledByAdminController.DEFAULT_FOREGROUND_USER_CHECKER, ActionDisabledLearnMoreButtonLauncher.DEFAULT_RESOLVE_ACTIVITY_CHECKER);
    }
