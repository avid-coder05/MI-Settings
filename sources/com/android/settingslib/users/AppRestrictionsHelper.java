...
public class AppRestrictionsHelper {
    ...
    private void addSystemApps(List<SelectableAppInfo> list, Intent intent, Set<String> set) {
        ...
        for (ResolveInfo resolveInfo : packageManager.queryIntentActivities(intent, 8704)) {
            ...
            if (activityInfo != null && (applicationInfo = activityInfo.applicationInfo) != null) {
                ...
                if ((i & 1) != 0 || (i & 128) != 0) {
                    if (!set.contains(str) && (((applicationEnabledSetting = packageManager.getApplicationEnabledSetting(str)) != 4 && applicationEnabledSetting != 2) || ((appInfoForUser = getAppInfoForUser(str, 0, this.mUser)) != null && (appInfoForUser.flags & MiuiWindowManager$LayoutParams.EXTRA_FLAG_IS_NO_SCREENSHOT) != 0))) {
    ...
    public void applyUserAppState(String str, boolean z, OnDisableUiForPackageListener onDisableUiForPackageListener) {
        ...
        try {
            ...
            ApplicationInfo applicationInfo = this.mIPm.getApplicationInfo(str, (int) MiuiWindowManager$LayoutParams.EXTRA_FLAG_ACQUIRES_SLEEP_TOKEN, identifier);
            if (applicationInfo == null || !applicationInfo.enabled || (applicationInfo.flags & MiuiWindowManager$LayoutParams.EXTRA_FLAG_IS_NO_SCREENSHOT) == 0) {
                this.mIPm.installExistingPackageAsUser(str, this.mUser.getIdentifier(), (int) MiuiWindowManager$LayoutParams.EXTRA_FLAG_ACQUIRES_SLEEP_TOKEN, 0, (List) null);
            }
            if (applicationInfo == null || (1 & applicationInfo.privateFlags) == 0 || (applicationInfo.flags & MiuiWindowManager$LayoutParams.EXTRA_FLAG_IS_NO_SCREENSHOT) == 0) {
                return;
            }
            onDisableUiForPackageListener.onDisableUiForPackage(str);
