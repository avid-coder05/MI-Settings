...
public class TwoTargetPreference extends Preference implements PreferenceFeature {
    ...
    public TwoTargetPreference(Context context, AttributeSet attributeSet, int i, int i2, boolean z) {
        super(context, attributeSet, i, i2, z);
        this.mHasIcon = false;
        init(context);
    }

    public TwoTargetPreference(Context context, AttributeSet attributeSet, int i, boolean z) {
        super(context, attributeSet, i, z);
        this.mHasIcon = false;
        init(context);
    }

    public TwoTargetPreference(Context context, AttributeSet attributeSet, boolean z) {
        super(context, attributeSet, z);
        this.mHasIcon = false;
        init(context);
    }

    public TwoTargetPreference(Context context, boolean z) {
        super(context, z);
        this.mHasIcon = false;
        init(context);
    }
