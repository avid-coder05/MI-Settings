...
public class ActionButtonsPreference extends Preference {
    ...
    private void updateLayout() {
        ...
        Button button = this.mButton1Info.mButton;
        Resources resources = getContext().getResources();
        int i = R$color.btn_bg;
        button.setBackgroundColor(resources.getColor(i));
        this.mButton2Info.mButton.setBackgroundColor(getContext().getResources().getColor(i));
        this.mButton3Info.mButton.setBackgroundColor(getContext().getResources().getColor(i));
        this.mButton4Info.mButton.setBackgroundColor(getContext().getResources().getColor(i));
        setupDivider1();
        setupDivider2();
        setupDivider3();
    }
    ...
    public ActionButtonsPreference setButton1Icon(int i) {
        ...
        try {
            ...
            if (isDarkModeEnable(getContext())) {
                DrawableCompat.setTint(drawable, getContext().getResources().getColor(R$color.btn_icon_night));
            }
            this.mButton1Info.mIcon = drawable;
            notifyChanged();
    ...
    public ActionButtonsPreference setButton2Icon(int i) {
        ...
        try {
            ...
            this.mButton2Info.mIcon = drawable;
            notifyChanged();
        } catch (Resources.NotFoundException unused) {
            Log.e("ActionButtonPreference", "Resource does not exist: " + i);
        }
    ...
    public ActionButtonsPreference setButton3Icon(int i) {
        ...
        try {
            ...
            this.mButton3Info.mIcon = drawable;
            notifyChanged();
        } catch (Resources.NotFoundException unused) {
            Log.e("ActionButtonPreference", "Resource does not exist: " + i);
        }
    ...
    public ActionButtonsPreference setButton4Icon(int i) {
        ...
        try {
            ...
            this.mButton4Info.mIcon = drawable;
            notifyChanged();
        } catch (Resources.NotFoundException unused) {
            Log.e("ActionButtonPreference", "Resource does not exist: " + i);
        }
