...
public class DevelopmentSettingsEnabler {
    public static boolean isDevelopmentSettingsEnabled(Context context) {
        ...
        return (!userManager.isAdminUser() || userManager.hasUserRestriction("no_debugging_features") || (Settings.Global.getInt(context.getContentResolver(), "development_settings_enabled", Build.TYPE.equals("eng") ? 1 : 0) != 0 ? 1 : null) == null) ? false : true;
    }
