...
public class ZenDurationDialog {
    ...
    protected void updateUi(ConditionTag conditionTag, View view, int i) {
        ...
        conditionTag.line1.setText(i != 0 ? i != 1 ? i != 2 ? "" : this.mContext.getString(R$string.zen_mode_duration_always_prompt_title) : ZenModeConfig.toTimeCondition(this.mContext, conditionTag.countdownZenDuration, ActivityManager.getCurrentUser(), false).line1 : this.mContext.getString(R$string.zen_mode_forever));
    }
