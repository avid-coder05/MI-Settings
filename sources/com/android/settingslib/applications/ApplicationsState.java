...
public class ApplicationsState {
    static WeakReference<ApplicationsState> sInstance;
    ...
    public static final Comparator<AppEntry> SIZE_COMPARATOR = new Comparator<AppEntry>() { // from class: com.android.settingslib.applications.ApplicationsState.3
        @Override // java.util.Comparator
        public int compare(AppEntry appEntry, AppEntry appEntry2) {
    ...
    public static final Comparator<AppEntry> INTERNAL_SIZE_COMPARATOR = new Comparator<AppEntry>() { // from class: com.android.settingslib.applications.ApplicationsState.4
        @Override // java.util.Comparator
        public int compare(AppEntry appEntry, AppEntry appEntry2) {
    ...
    public static final Comparator<AppEntry> EXTERNAL_SIZE_COMPARATOR = new Comparator<AppEntry>() { // from class: com.android.settingslib.applications.ApplicationsState.5
        @Override // java.util.Comparator
        public int compare(AppEntry appEntry, AppEntry appEntry2) {
    ...
    public static final AppFilter FILTER_PERSONAL = new AppFilter() { // from class: com.android.settingslib.applications.ApplicationsState.6
    ...
    public static final AppFilter FILTER_WITHOUT_DISABLED_UNTIL_USED = new AppFilter() { // from class: com.android.settingslib.applications.ApplicationsState.7
        @Override // com.android.settingslib.applications.ApplicationsState.AppFilter
        public boolean filterApp(AppEntry appEntry) {
    ...
    public static final AppFilter FILTER_WORK = new AppFilter() { // from class: com.android.settingslib.applications.ApplicationsState.8
        private int mCurrentUser;
    ...
    public static final AppFilter FILTER_DOWNLOADED_AND_LAUNCHER_AND_INSTANT = new AppFilter() { // from class: com.android.settingslib.applications.ApplicationsState.10
        @Override // com.android.settingslib.applications.ApplicationsState.AppFilter
        public boolean filterApp(AppEntry appEntry) {
    ...
    public static final AppFilter FILTER_THIRD_PARTY = new AppFilter() { // from class: com.android.settingslib.applications.ApplicationsState.11
        @Override // com.android.settingslib.applications.ApplicationsState.AppFilter
        public boolean filterApp(AppEntry appEntry) {
    ...
    public static final AppFilter FILTER_DISABLED = new AppFilter() { // from class: com.android.settingslib.applications.ApplicationsState.12
        @Override // com.android.settingslib.applications.ApplicationsState.AppFilter
        public boolean filterApp(AppEntry appEntry) {
    ...
    public static final AppFilter FILTER_INSTANT = new AppFilter() { // from class: com.android.settingslib.applications.ApplicationsState.13
        @Override // com.android.settingslib.applications.ApplicationsState.AppFilter
        public boolean filterApp(AppEntry appEntry) {
    ...
    public static final AppFilter FILTER_ALL_ENABLED = new AppFilter() { // from class: com.android.settingslib.applications.ApplicationsState.14
        @Override // com.android.settingslib.applications.ApplicationsState.AppFilter
        public boolean filterApp(AppEntry appEntry) {
            ApplicationInfo applicationInfo = appEntry.info;
    ...
    public static final AppFilter FILTER_EVERYTHING = new AppFilter() { // from class: com.android.settingslib.applications.ApplicationsState.15
        @Override // com.android.settingslib.applications.ApplicationsState.AppFilter
        public boolean filterApp(AppEntry appEntry) {
            return true;
        }
    ...
    public static final AppFilter FILTER_WITH_DOMAIN_URLS = new AppFilter() { // from class: com.android.settingslib.applications.ApplicationsState.16
        @Override // com.android.settingslib.applications.ApplicationsState.AppFilter
        public boolean filterApp(AppEntry appEntry) {
    ...
    public static final AppFilter FILTER_NOT_HIDE = new AppFilter() { // from class: com.android.settingslib.applications.ApplicationsState.17
    ...
    public static final AppFilter FILTER_GAMES = new AppFilter() { // from class: com.android.settingslib.applications.ApplicationsState.18
        @Override // com.android.settingslib.applications.ApplicationsState.AppFilter
        public boolean filterApp(AppEntry appEntry) {
            boolean z;
            synchronized (appEntry.info) {
                z = ApplicationsState.hasFlag(appEntry.info.flags, MiuiWindowManager$LayoutParams.EXTRA_FLAG_IS_PIP_SCREEN_PROJECTION) || appEntry.info.category == 0;
            }
            return z;
        }
    ...
    public static final AppFilter FILTER_AUDIO = new AppFilter() { // from class: com.android.settingslib.applications.ApplicationsState.19
        @Override // com.android.settingslib.applications.ApplicationsState.AppFilter
        public boolean filterApp(AppEntry appEntry) {
            boolean z;
    ...
    public static final AppFilter FILTER_MOVIES = new AppFilter() { // from class: com.android.settingslib.applications.ApplicationsState.20
        @Override // com.android.settingslib.applications.ApplicationsState.AppFilter
        public boolean filterApp(AppEntry appEntry) {
            boolean z;
            synchronized (appEntry) {
    ...
    public static final AppFilter FILTER_PHOTOS = new AppFilter() { // from class: com.android.settingslib.applications.ApplicationsState.21
        @Override // com.android.settingslib.applications.ApplicationsState.AppFilter
        public boolean filterApp(AppEntry appEntry) {
            boolean z;
            synchronized (appEntry) {
    ...
    public static final AppFilter FILTER_OTHER_APPS = new AppFilter() { // from class: com.android.settingslib.applications.ApplicationsState.22
        @Override // com.android.settingslib.applications.ApplicationsState.AppFilter
        public boolean filterApp(AppEntry appEntry) {
            boolean z;
            synchronized (appEntry) {
    ...
    public static final AppFilter FILTER_APPS_EXCEPT_GAMES = new AppFilter() { // from class: com.android.settingslib.applications.ApplicationsState.23
        @Override // com.android.settingslib.applications.ApplicationsState.AppFilter
        public boolean filterApp(AppEntry appEntry) {
            boolean filterApp;
            synchronized (appEntry) {
    ...
    public static class AppEntry extends SizeInfo {
        ...
        public AppEntry(final Context context, ApplicationInfo applicationInfo, long j) {
            ...
            this.isXSpaceApp = XSpaceUserHandle.isUidBelongtoXSpace(applicationInfo.uid);
            ensureLabel(context);
        ...
        boolean ensureIconLocked(Context context) {
            if (this.icon == null) {
                ...
                this.mounted = false;
                this.icon = context.getDrawable(17303718);
        ...
        public void ensureLabel(Context context) {
            if (this.label == null || !this.mounted) {
                ...
                if (str != null) {
                    ...
                    ArrayList<ChinesePinyinConverter.Token> arrayList = ChinesePinyinConverter.getInstance(context.getApplicationContext()).get(trim);
                    if (arrayList == null || arrayList.size() <= 0) {
                        return;
                    }
                    this.py = arrayList.get(0).target;
                }
            }
        }
        ...
        public Drawable getIcon(Context context) {
            ...
            Drawable iconDrawable = AppIconsHelper.getIconDrawable(applicationContext, this.info, applicationContext.getPackageManager(), 600000L);
            return XSpaceUserHandle.isUidBelongtoXSpace(this.info.uid) ? XSpaceUserHandle.getXSpaceIcon(applicationContext, iconDrawable) : iconDrawable;
        }
                        ...
                        for (int i5 = 0; i5 < ApplicationsState.this.mApplications.size() && i < 6; i5++) {
                            ...
                            if (userId != 0) {
                                if (ApplicationsState.this.mEntriesMap.indexOfKey(0) >= 0) {
                                    ...
                                    if (appEntry != null && !ApplicationsState.hasFlag(appEntry.info.flags, MiuiWindowManager$LayoutParams.EXTRA_FLAG_IS_NO_SCREENSHOT)) {
                    ...
                    if (ApplicationsState.hasFlag(combinedSessionFlags, 4)) {
                        synchronized (ApplicationsState.this.mEntriesMap) {
                            ...
                            for (int i9 = 0; i9 < ApplicationsState.this.mAppEntries.size(); i9++) {
                                ...
                                if (ApplicationsState.hasFlag(appEntry5.info.flags, MiuiWindowManager$LayoutParams.EXTRA_FLAG_IS_NO_SCREENSHOT) && (appEntry5.size == -1 || appEntry5.sizeStale)) {
    ...
    public class Session implements LifecycleObserver {
        ...
        void doReleaseIfNeededLocked() {
            if (ApplicationsState.this.mSessions.isEmpty()) {
                ApplicationsState.this.clearEntries();
                ApplicationsState.this.mAppEntries.clear();
            }
        }
        ...
        public void onDestroy() {
            ...
            synchronized (ApplicationsState.this.mEntriesMap) {
                ...
                ArrayList<AppEntry> arrayList = this.mRebuildResult;
                if (arrayList != null) {
                    arrayList.clear();
                }
                ArrayList<AppEntry> arrayList2 = this.mLastAppList;
                if (arrayList2 != null) {
                    arrayList2.clear();
                }
    ...
    private static boolean anyAppIsRemoved(List<ApplicationInfo> list, List<ApplicationInfo> list2) {
        ...
        for (ApplicationInfo applicationInfo : list2) {
            ...
            if (hasFlag(applicationInfo.flags, MiuiWindowManager$LayoutParams.EXTRA_FLAG_IS_NO_SCREENSHOT)) {
                hashSet2.add(applicationInfo.packageName);
            }
        }
        for (ApplicationInfo applicationInfo2 : list) {
            if (hasFlag(applicationInfo2.flags, MiuiWindowManager$LayoutParams.EXTRA_FLAG_IS_NO_SCREENSHOT) && ((hashSet = (HashSet) hashMap.get(String.valueOf(UserHandle.getUserId(applicationInfo2.uid)))) == null || !hashSet.remove(applicationInfo2.packageName))) {
                return true;
            }
        }
        return false;
    ...
    private void filterXSpaceSystemApp(List<ApplicationInfo> list) {
        ...
        while (it.hasNext()) {
            ...
            if (XSpaceUserHandle.isUidBelongtoXSpace(next.uid) && (XSpaceConstant.REQUIRED_APPS.contains(next.packageName) || Constants.XMSF_PACKAGE_NAME.equals(next.packageName))) {
                it.remove();
            }
        }
    }
    ...
    public static ApplicationsState getInstance(Application application, IPackageManager iPackageManager) {
        ...
        synchronized (sLock) {
            WeakReference<ApplicationsState> weakReference = sInstance;
            if (weakReference == null || weakReference.get() == null) {
                sInstance = new WeakReference<>(new ApplicationsState(application, iPackageManager));
            }
            applicationsState = sInstance.get();
        }
    ...
    public AppEntry getEntry(String str, int i) {
        ...
        synchronized (this.mEntriesMap) {
            ...
            if (appEntry == null && !TextUtils.isEmpty(str)) {
                ApplicationInfo appInfoLocked = getAppInfoLocked(str, i);
                if (appInfoLocked == null) {
                    try {
                        appInfoLocked = this.mIpm.getApplicationInfo(str, 128, i);
    ...
    public void requestSize(final String str, final int i) {
        synchronized (this.mEntriesMap) {
            ...
            if (appEntry != null && hasFlag(appEntry.info.flags, MiuiWindowManager$LayoutParams.EXTRA_FLAG_IS_NO_SCREENSHOT)) {
