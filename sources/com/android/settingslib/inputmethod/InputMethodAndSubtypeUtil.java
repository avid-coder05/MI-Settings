...
public class InputMethodAndSubtypeUtil {
    ...
    public static void enableInputMethodSubtypesOf(ContentResolver contentResolver, String str, HashSet<String> hashSet) {
        HashMap<String, HashSet<String>> enabledInputMethodsAndSubtypeList = getEnabledInputMethodsAndSubtypeList(contentResolver);
        enabledInputMethodsAndSubtypeList.put(str, hashSet);
        Settings.Secure.putString(contentResolver, "enabled_input_methods", buildInputMethodsAndSubtypesString(enabledInputMethodsAndSubtypeList));
    }
    ...
    private static Locale getDisplayLocale(Context context) {
        ...
        Locale locale;
        return (context == null || context.getResources() == null || (configuration = context.getResources().getConfiguration()) == null || (locale = configuration.getLocales().get(0)) == null) ? Locale.getDefault() : locale;
    }
