...
public abstract class PreferenceDialogFragment extends DialogFragment implements DialogInterface.OnClickListener {
    ...
    public androidx.preference.Preference getPreference() {
        if (this.mPreference == null) {
            this.mPreference = (androidx.preference.DialogPreference) ((DialogPreference.TargetFragment) getTargetFragment()).findPreference(getArguments().getString(SettingsProvider.ARGS_KEY));
        }
    ...
    public void onCreate(Bundle bundle) {
        ...
        String string = getArguments().getString(SettingsProvider.ARGS_KEY);
        if (bundle != null) {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        AlertDialog.Builder negativeButton = new AlertDialog.Builder(activity, R$style.AlertDialog_Theme_DayNight).setTitle(this.mDialogTitle).setIcon(this.mDialogIcon).setPositiveButton(this.mPositiveButtonText, this).setNegativeButton(this.mNegativeButtonText, this);
