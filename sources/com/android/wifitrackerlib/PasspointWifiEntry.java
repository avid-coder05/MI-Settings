...
public class PasspointWifiEntry extends WifiEntry implements WifiEntry.WifiEntryCallback {
    ...
    */
    ...
    @Override // com.android.wifitrackerlib.WifiEntry
    public synchronized boolean isPasspointR1() {
        return this.mPasspointR1WifiEntry != null;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setPasspointR1WifiEntry(PasspointR1WifiEntry passpointR1WifiEntry) {
        this.mPasspointR1WifiEntry = passpointR1WifiEntry;
        if (passpointR1WifiEntry != null) {
            passpointR1WifiEntry.setListener(this);
        }
    }
