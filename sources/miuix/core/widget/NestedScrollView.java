...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3 {
    ...
    public void computeScroll() {
        ...
        for (ViewParent parent = getParent(); parent != null && ((!(parent instanceof NestedCurrentFling) || !((NestedCurrentFling) parent).onNestedCurrentFling(this.mScroller.getCurrVelocityX(), this.mScroller.getCurrVelocityY())) && (!(parent instanceof ViewGroup) || parent != findViewById)); parent = parent.getParent()) {
        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.mFillViewport && View.MeasureSpec.getMode(i2) != 0 && getChildCount() > 0) {
            ...
            if (measuredHeight < measuredHeight2) {
                childAt.measure(FrameLayout.getChildMeasureSpec(i, getPaddingLeft() + getPaddingRight() + layoutParams.leftMargin + layoutParams.rightMargin, layoutParams.width), View.MeasureSpec.makeMeasureSpec(measuredHeight2, SearchUpdater.SIM));
            }
        }
    }
