...
public class ViewPager extends ViewGroup {
    ...
    */
    ...
    protected void onMeasure(int i, int i2) {
        ...
        View.MeasureSpec.makeMeasureSpec(paddingLeft, SearchUpdater.SIM);
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(measuredHeight, SearchUpdater.SIM);
        this.mInLayout = true;
        populate();
        ...
        for (int i12 = 0; i12 < childCount2; i12++) {
            ...
            if (childAt2.getVisibility() != 8 && ((layoutParams = (LayoutParams) childAt2.getLayoutParams()) == null || !layoutParams.isDecor)) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (paddingLeft * layoutParams.widthFactor), SearchUpdater.SIM), makeMeasureSpec);
            }
        }
    }
