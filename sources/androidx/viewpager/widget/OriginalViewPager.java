...
public class OriginalViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new Comparator<ItemInfo>() { // from class: androidx.viewpager.widget.OriginalViewPager.1
        @Override // java.util.Comparator
        public int compare(ItemInfo itemInfo, ItemInfo itemInfo2) {
            return itemInfo.position - itemInfo2.position;
        }
    };
    private static final Interpolator sInterpolator = new Interpolator() { // from class: androidx.viewpager.widget.OriginalViewPager.2
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.widthFactor = 0.0f;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, OriginalViewPager.LAYOUT_ATTRS);
    ...
    public class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        private boolean canScroll() {
            PagerAdapter pagerAdapter = OriginalViewPager.this.mAdapter;
        ...
        public void onInitializeAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
            ...
            if (accessibilityEvent.getEventType() != 4096 || (pagerAdapter = OriginalViewPager.this.mAdapter) == null) {
                return;
            }
            accessibilityEvent.setItemCount(pagerAdapter.getCount());
            accessibilityEvent.setFromIndex(OriginalViewPager.this.mCurItem);
            accessibilityEvent.setToIndex(OriginalViewPager.this.mCurItem);
        }

        @Override // androidx.core.view.AccessibilityDelegateCompat
        public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            super.onInitializeAccessibilityNodeInfo(view, accessibilityNodeInfoCompat);
            accessibilityNodeInfoCompat.setClassName(OriginalViewPager.class.getName());
        ...
        public boolean performAccessibilityAction(View view, int i, Bundle bundle) {
            ...
            if (i == 4096) {
                if (OriginalViewPager.this.canScrollHorizontally(1)) {
                    ...
                    originalViewPager.setCurrentItem(originalViewPager.mCurItem + 1);
                    return true;
                }
                return false;
            } else if (i == 8192 && OriginalViewPager.this.canScrollHorizontally(-1)) {
                OriginalViewPager originalViewPager2 = OriginalViewPager.this;
                originalViewPager2.setCurrentItem(originalViewPager2.mCurItem - 1);
                return true;
            } else {
                return false;
            }
    ...
    public interface OnAdapterChangeListener {
        void onAdapterChanged(miuix.viewpager.widget.ViewPager viewPager, PagerAdapter pagerAdapter, PagerAdapter pagerAdapter2);
    }
    ...
    private class PagerObserver extends DataSetObserver {
        ...
        public void onChanged() {
            OriginalViewPager.this.dataSetChanged();
        }
    ...
    public OriginalViewPager(Context context) {
        super(context);
        ...
        this.mEndScrollRunnable = new Runnable() { // from class: androidx.viewpager.widget.OriginalViewPager.3
            @Override // java.lang.Runnable
            public void run() {
                OriginalViewPager.this.setScrollState(0);
                OriginalViewPager.this.populate();
            }
        };
        this.mScrollState = 0;
        initViewPager();
    ...
    public OriginalViewPager(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.mItems = new ArrayList<>();
        this.mTempItem = new ItemInfo();
        this.mTempRect = new Rect();
    ...
    */
    public boolean arrowScroll(int r7) {
        ...
        Ld6:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.viewpager.widget.OriginalViewPager.arrowScroll(int):boolean");
    }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new OnApplyWindowInsetsListener() { // from class: androidx.viewpager.widget.OriginalViewPager.4
            ...
            public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                ...
                for (int i = 0; i < childCount; i++) {
                    WindowInsetsCompat dispatchApplyWindowInsets = ViewCompat.dispatchApplyWindowInsets(OriginalViewPager.this.getChildAt(i), onApplyWindowInsets);
    ...
    protected void onDetachedFromWindow() {
        ...
        SpringScroller springScroller = this.mScroller;
        if (springScroller != null && !springScroller.isFinished()) {
            this.mScroller.abortAnimation();
        }
    ...
    */
    ...
    public void onMeasure(int i, int i2) {
        ...
        this.mChildWidthMeasureSpec = View.MeasureSpec.makeMeasureSpec(paddingLeft, SearchUpdater.SIM);
        this.mChildHeightMeasureSpec = View.MeasureSpec.makeMeasureSpec(measuredHeight, SearchUpdater.SIM);
        this.mInLayout = true;
        populate();
        ...
        for (int i12 = 0; i12 < childCount2; i12++) {
            ...
            if (childAt2.getVisibility() != 8 && ((layoutParams = (LayoutParams) childAt2.getLayoutParams()) == null || !layoutParams.isDecor)) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (paddingLeft * layoutParams.widthFactor), SearchUpdater.SIM), this.mChildHeightMeasureSpec);
            }
        }
    }
    ...
    */
    protected void onPageScrolled(int r13, float r14, int r15) {
        ...
        L1b:
            ...
            androidx.viewpager.widget.OriginalViewPager$LayoutParams r9 = (androidx.viewpager.widget.OriginalViewPager.LayoutParams) r9
        ...
        L6b:
            ...
            androidx.viewpager.widget.OriginalViewPager$PageTransformer r13 = r12.mPageTransformer
            if (r13 == 0) goto L9f
        ...
        L7a:
            ...
            androidx.viewpager.widget.OriginalViewPager$LayoutParams r0 = (androidx.viewpager.widget.OriginalViewPager.LayoutParams) r0
        ...
        L8b:
            ...
            float r3 = (float) r3
            float r0 = r0 / r3
            androidx.viewpager.widget.OriginalViewPager$PageTransformer r3 = r12.mPageTransformer
        ...
        L9f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.viewpager.widget.OriginalViewPager.onPageScrolled(int, float, int):void");
    }
    ...
    */
    void populate(int r18) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.viewpager.widget.OriginalViewPager.populate(int):void");
    }
    ...
    public void setAdapter(PagerAdapter pagerAdapter) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            this.mAdapterChangeListeners.get(i2).onAdapterChanged((miuix.viewpager.widget.ViewPager) this, pagerAdapter3, pagerAdapter);
        }
    }
    ...
    void smoothScrollTo(int i, int i2, int i3) {
        ...
        SpringScroller springScroller = this.mScroller;
        if ((springScroller == null || springScroller.isFinished()) ? false : true) {
        ...
        this.mScroller.startScroll(scrollX, i, scrollY, i2, -i3);
        ViewCompat.postInvalidateOnAnimation(this);
    }
