...
public abstract class ExploreByTouchHelper extends AccessibilityDelegateCompat {
    ...
    private boolean clearAccessibilityFocus(int i) {
        if (this.mAccessibilityFocusedVirtualViewId == i) {
            ...
            sendEventForVirtualView(i, SearchUpdater.GOOGLE);
            return true;
        }
        return false;
    }
    ...
    private boolean requestAccessibilityFocus(int i) {
        ...
        if (this.mManager.isEnabled() && this.mManager.isTouchExplorationEnabled() && (i2 = this.mAccessibilityFocusedVirtualViewId) != i) {
            ...
            this.mHost.invalidate();
            sendEventForVirtualView(i, MiuiWindowManager$LayoutParams.EXTRA_FLAG_DISABLE_FOD_ICON);
            return true;
        }
        return false;
    }
    ...
    public final void invalidateVirtualView(int i, int i2) {
        ...
        AccessibilityEvent createEvent = createEvent(i, MiuiWindowManager$LayoutParams.EXTRA_FLAG_FINDDEVICE_KEYGUARD);
