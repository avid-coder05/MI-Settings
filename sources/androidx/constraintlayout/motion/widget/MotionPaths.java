...
public class MotionPaths implements Comparable<MotionPaths> {
    static String[] names = {"position", "x", "y", Tag.TagWebService.ContentGetImage.PARAM_IMAGE_WIDTH, "height", "pathRotate"};
    ...
    public void setView(View view, int[] iArr, double[] dArr, double[] dArr2, double[] dArr3) {
        ...
        if ((i8 == view.getMeasuredWidth() && i9 == view.getMeasuredHeight()) ? false : z3) {
            view.measure(View.MeasureSpec.makeMeasureSpec(i8, SearchUpdater.SIM), View.MeasureSpec.makeMeasureSpec(i9, SearchUpdater.SIM));
        }
