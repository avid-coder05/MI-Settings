    ...
    public class Measurer implements BasicMeasure.Measurer {
        ...
        public final void measure(ConstraintWidget constraintWidget, BasicMeasure.Measure measure) {
            ...
            if (constraintWidget.getVisibility() == 8 && !constraintWidget.isInPlaceholder()) {
                ...
                if (i8 == 1) {
                    makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i4, SearchUpdater.SIM);
                } else if (i8 == 2) {
                    ...
                    if (i9 == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || i9 == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS) {
                        if (measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z || (z && (view.getMeasuredHeight() == constraintWidget.getHeight())) || (view instanceof Placeholder) || constraintWidget.isResolvedHorizontally()) {
                            makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(constraintWidget.getWidth(), SearchUpdater.SIM);
                        }
                    }
                }
                int i10 = iArr[dimensionBehaviour2.ordinal()];
                if (i10 == 1) {
                    makeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(i5, SearchUpdater.SIM);
                } else if (i10 == 2) {
                    ...
                    if (i11 == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || i11 == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS) {
                        if (measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z2 || (z2 && (view.getMeasuredWidth() == constraintWidget.getWidth())) || (view instanceof Placeholder) || constraintWidget.isResolvedVertically()) {
                            makeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(constraintWidget.getHeight(), SearchUpdater.SIM);
                        }
                    }
                }
                ...
                if (i12 != BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS && i12 != BasicMeasure.Measure.USE_GIVEN_DIMENSIONS && z3 && constraintWidget.mMatchConstraintDefaultWidth == 0 && z4 && constraintWidget.mMatchConstraintDefaultHeight == 0) {
                    ...
                    if (measuredWidth != max || measuredHeight != i2) {
                        int makeMeasureSpec3 = measuredWidth != max ? View.MeasureSpec.makeMeasureSpec(max, SearchUpdater.SIM) : i;
                        if (measuredHeight != i2) {
                            makeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(i2, SearchUpdater.SIM);
                        }
    ...
    */
    ...
    public boolean isRtl() {
        if (Build.VERSION.SDK_INT >= 17) {
            return ((getContext().getApplicationInfo().flags & MiuiWindowManager$LayoutParams.EXTRA_FLAG_ACQUIRES_SLEEP_TOKEN) != 0) && 1 == getLayoutDirection();
        }
        return false;
    }
    ...
    public void resolveMeasuredDimension(int i, int i2, int i3, int i4, boolean z, boolean z2) {
        ...
        if (z) {
            min |= MiuiWindowManager$LayoutParams.EXTRA_FLAG_IS_SCREEN_PROJECTION;
        }
        if (z2) {
            min2 |= MiuiWindowManager$LayoutParams.EXTRA_FLAG_IS_SCREEN_PROJECTION;
        }
