...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public void draw(Canvas canvas) {
        ...
        int min = Math.min((int) MiuiWindowManager$LayoutParams.EXTRA_FLAG_FINDDEVICE_KEYGUARD, (int) (this.mTmpBounds.width() * abs));
        int min2 = Math.min((int) MiuiWindowManager$LayoutParams.EXTRA_FLAG_FINDDEVICE_KEYGUARD, (int) (this.mTmpBounds.height() * abs2));
        if (min <= 0 || min2 <= 0) {
            return;
        }
