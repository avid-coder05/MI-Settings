...
public final class TaskStackBuilder implements Iterable<Intent> {
    ...
    public PendingIntent getPendingIntent(int requestCode, int flags, Bundle options) {
        ...
        return Build.VERSION.SDK_INT >= 16 ? PendingIntent.getActivities(this.mSourceContext, requestCode, intentArr, flags, options) : PendingIntent.getActivities(this.mSourceContext, requestCode, intentArr, flags);
    }
