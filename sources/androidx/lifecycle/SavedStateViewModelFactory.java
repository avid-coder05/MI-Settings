...
public final class SavedStateViewModelFactory extends ViewModelProvider.KeyedFactory {
    ...
    public <T extends ViewModel> T create(String key, Class<T> modelClass) {
        ...
        Constructor findMatchingConstructor = (!isAssignableFrom || this.mApplication == null) ? findMatchingConstructor(modelClass, VIEWMODEL_SIGNATURE) : findMatchingConstructor(modelClass, ANDROID_VIEWMODEL_SIGNATURE);
