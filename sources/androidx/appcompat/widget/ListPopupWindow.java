...
public class ListPopupWindow implements ShowableListMenu {
    ...
    private int buildDropDown() {
        ...
        if (i7 == -2) {
            ...
            makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i7, SearchUpdater.SIM);
        } else {
            int i9 = this.mContext.getResources().getDisplayMetrics().widthPixels;
            Rect rect3 = this.mTempRect;
            makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i9 - (rect3.left + rect3.right), SearchUpdater.SIM);
        }
