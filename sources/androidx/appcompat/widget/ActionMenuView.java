...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
    ...
    public static int measureChildForCells(View view, int i, int i2, int i3, int i4) {
        ...
        view.measure(View.MeasureSpec.makeMeasureSpec(i * i5, SearchUpdater.SIM), makeMeasureSpec);
        return i5;
    }
        ...
        if (z2) {
            for (int i35 = i6; i35 < childCount; i35++) {
                ...
                if (layoutParams5.expanded) {
                    childAt4.measure(View.MeasureSpec.makeMeasureSpec((layoutParams5.cellsUsed * i12) + layoutParams5.extraPixels, SearchUpdater.SIM), childMeasureSpec);
                }
            }
        }
