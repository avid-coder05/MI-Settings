...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    private Intent createVoiceAppSearchIntent(Intent intent, SearchableInfo searchableInfo) {
        ...
        PendingIntent activity = PendingIntent.getActivity(getContext(), 0, intent2, SearchUpdater.SIM);
    ...
    private boolean hasVoiceSearch() {
        ...
        return (intent == null || getContext().getPackageManager().resolveActivity(intent, SearchUpdater.GOOGLE) == null) ? false : true;
    }
    ...
    private void updateSearchAutoComplete() {
        ...
        if ((inputType & 15) == 1) {
            ...
            if (this.mSearchable.getSuggestAuthority() != null) {
                inputType = inputType | SearchUpdater.GOOGLE | 524288;
            }
        }
    ...
    public void onActionViewExpanded() {
        ...
        this.mSearchSrcTextView.setImeOptions(imeOptions | MiuiWindowManager$LayoutParams.EXTRA_FLAG_IS_PIP_SCREEN_PROJECTION);
