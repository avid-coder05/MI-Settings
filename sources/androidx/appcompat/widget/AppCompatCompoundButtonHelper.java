    ...
    */
    public void loadFromAttributes(android.util.AttributeSet r10, int r11) {
        ...
        L69:
            ...
            boolean r11 = r0.hasValue(r10)     // Catch: java.lang.Throwable -> L84
            if (r11 == 0) goto L80
            android.widget.CompoundButton r9 = r9.mView     // Catch: java.lang.Throwable -> L84
            r11 = -1
            ...
            androidx.core.widget.CompoundButtonCompat.setButtonTintMode(r9, r10)     // Catch: java.lang.Throwable -> L84
        L80:
            r0.recycle()
            return
        L84:
